...
public class AppCompatCheckBox extends CheckBox implements C0558m, C3772t {

    /* renamed from: g */
    private final C0273e f930g;

    /* renamed from: h */
    private final C0271d f931h;

    /* renamed from: i */
    private final C0292l f932i;
    ...
    public void drawableStateChanged() {
        ...
        C0271d dVar = this.f931h;
        if (dVar != null) {
            dVar.mo1944b();
        }
        C0292l lVar = this.f932i;
        if (lVar != null) {
            lVar.mo2062b();
        }
    }
    ...
    public AppCompatCheckBox(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C3400a.checkboxStyle);
    }
