...
public class AppCompatAutoCompleteTextView extends AutoCompleteTextView implements C3772t {

    /* renamed from: i */
    private static final int[] f925i = {16843126};

    /* renamed from: g */
    private final C0271d f926g;

    /* renamed from: h */
    private final C0292l f927h;
    ...
    public void drawableStateChanged() {
        ...
        C0271d dVar = this.f926g;
        if (dVar != null) {
            dVar.mo1944b();
        }
        C0292l lVar = this.f927h;
        if (lVar != null) {
            lVar.mo2062b();
        }
    }
    ...
    public AppCompatAutoCompleteTextView(Context context, AttributeSet attributeSet, int i) {
        ...
        C0279g0 v = C0279g0.m1627v(getContext(), attributeSet, f925i, i, 0);
        if (v.mo1994s(0)) {
