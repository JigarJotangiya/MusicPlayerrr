...
public class AlertDialogLayout extends LinearLayoutCompat {
    ...
    /* renamed from: A */
    private void m1303A(View view, int i, int i2, int i3, int i4) {
        view.layout(i, i2, i3 + i, i4 + i2);
    }

    /* renamed from: B */
    private static int m1304B(View view) {
        int C = C3774v.m16153C(view);
        if (C > 0) {
            return C;
        }
        if (view instanceof ViewGroup) {
            ...
            if (viewGroup.getChildCount() == 1) {
                return m1304B(viewGroup.getChildAt(0));
            }
        }
        return 0;
    }
    ...
    /* renamed from: C */
    private boolean m1305C(int i, int i2) {
        int i3;
        int i4;
        int i5;
        int i6;
        ...
        for (int i10 = 0; i10 < childCount; i10++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (id == C3405f.topPanel) {
                    view = childAt;
                } else if (id == C3405f.buttonPanel) {
                    view2 = childAt;
                } else if ((id != C3405f.contentPanel && id != C3405f.customPanel) || view3 != null) {
                    return false;
                } else {
                    view3 = childAt;
                }
        ...
        m1306k(childCount, i9);
        return true;
    }

    /* renamed from: k */
    private void m1306k(int i, int i2) {
    ...
    public void onLayout(boolean r18, int r19, int r20, int r21, int r22) {
        ...
        L_0x005a:
            ...
            r2 = r11
        L_0x007e:
            int r3 = p082e.p109h.p119p.C3774v.m16151B(r17)
            int r2 = p082e.p109h.p119p.C3733e.m15972b(r2, r3)
            r2 = r2 & 7
            r3 = 1
