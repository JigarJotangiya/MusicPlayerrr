...
public final class C1236e {
    ...
    /* renamed from: b */
    private static final String f5044b = C1405l.m7462f("Data");

    /* renamed from: c */
    public static final C1236e f5045c = new C1237a().mo6509a();
    ...
    public static final class C1237a {
        ...
        /* renamed from: a */
        private Map<String, Object> f5047a = new HashMap();

        /* renamed from: a */
        public C1236e mo6509a() {
            C1236e eVar = new C1236e((Map<String, ?>) this.f5047a);
            C1236e.m6904k(eVar);
            return eVar;
        }

        /* renamed from: b */
        public C1237a mo6510b(String str, Object obj) {
            if (obj == null) {
                this.f5047a.put(str, (Object) null);
            } else {
                Class<?> cls = obj.getClass();
                if (cls == Boolean.class || cls == Byte.class || cls == Integer.class || cls == Long.class || cls == Float.class || cls == Double.class || cls == String.class || cls == Boolean[].class || cls == Byte[].class || cls == Integer[].class || cls == Long[].class || cls == Float[].class || cls == Double[].class || cls == String[].class) {
                    this.f5047a.put(str, obj);
                } else if (cls == boolean[].class) {
                    this.f5047a.put(str, C1236e.m6897a((boolean[]) obj));
                } else if (cls == byte[].class) {
                    this.f5047a.put(str, C1236e.m6898b((byte[]) obj));
                } else if (cls == int[].class) {
                    this.f5047a.put(str, C1236e.m6901e((int[]) obj));
                } else if (cls == long[].class) {
                    this.f5047a.put(str, C1236e.m6902f((long[]) obj));
                } else if (cls == float[].class) {
                    this.f5047a.put(str, C1236e.m6900d((float[]) obj));
                } else if (cls == double[].class) {
                    this.f5047a.put(str, C1236e.m6899c((double[]) obj));
                } else {
        ...
        /* renamed from: c */
        public C1237a mo6511c(C1236e eVar) {
            mo6512d(eVar.f5046a);
            return this;
        }

        /* renamed from: d */
        public C1237a mo6512d(Map<String, Object> map) {
            for (Map.Entry next : map.entrySet()) {
                mo6510b((String) next.getKey(), next.getValue());
            }
            return this;
        }

        /* renamed from: e */
        public C1237a mo6513e(String str, String str2) {
    ...
    /* renamed from: a */
    public static Boolean[] m6897a(boolean[] zArr) {
    ...
    /* renamed from: b */
    public static Byte[] m6898b(byte[] bArr) {
    ...
    /* renamed from: c */
    public static Double[] m6899c(double[] dArr) {
    ...
    /* renamed from: d */
    public static Float[] m6900d(float[] fArr) {
    ...
    /* renamed from: e */
    public static Integer[] m6901e(int[] iArr) {
    ...
    /* renamed from: f */
    public static Long[] m6902f(long[] jArr) {
    ...
    public static androidx.work.C1236e m6903g(byte[] r7) {
        /*
        ...
        L_0x0080:
            ...
            throw r7
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.work.C1236e.m6903g(byte[]):androidx.work.e");
    }
    ...
    /* renamed from: k */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static byte[] m6904k(androidx.work.C1236e r5) {
        /*
            ...
            int r2 = r5.mo6507j()     // Catch:{ IOException -> 0x0067, all -> 0x0064 }
            r3.writeInt(r2)     // Catch:{ IOException -> 0x0067, all -> 0x0064 }
            java.util.Map<java.lang.String, java.lang.Object> r5 = r5.f5046a     // Catch:{ IOException -> 0x0067, all -> 0x0064 }
        ...
        L_0x00a3:
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.work.C1236e.m6904k(androidx.work.e):byte[]");
    }
    ...
    public boolean equals(Object obj) {
        ...
        C1236e eVar = (C1236e) obj;
        Set<String> keySet = this.f5046a.keySet();
        if (!keySet.equals(eVar.f5046a.keySet())) {
            return false;
        }
        for (String next : keySet) {
            Object obj2 = this.f5046a.get(next);
            Object obj3 = eVar.f5046a.get(next);
    ...
    /* renamed from: h */
    public Map<String, Object> mo6504h() {
        return Collections.unmodifiableMap(this.f5046a);
    }
    ...
    /* renamed from: i */
    public String mo6506i(String str) {
        Object obj = this.f5046a.get(str);
    ...
    public String toString() {
        ...
        if (!this.f5046a.isEmpty()) {
            for (String next : this.f5046a.keySet()) {
                sb.append(next);
                sb.append(" : ");
                Object obj = this.f5046a.get(next);
    ...
    public C1236e(C1236e eVar) {
        this.f5046a = new HashMap(eVar.f5046a);
    }

    public C1236e(Map<String, ?> map) {
        this.f5046a = new HashMap(map);
    }
}
