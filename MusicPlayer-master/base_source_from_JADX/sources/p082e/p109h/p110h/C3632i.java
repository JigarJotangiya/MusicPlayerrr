...
/* renamed from: e.h.h.i */
/* compiled from: TypefaceCompatApi29Impl */
public class C3632i extends C3633j {
    /* renamed from: b */
    public Typeface mo12885b(Context context, C0516c.C0518b bVar, Resources resources, int i) {
        try {
            ...
            while (true) {
                ...
                C0516c.C0519c cVar = a[i3];
                try {
                    Font.Builder weight = new Font.Builder(resources, cVar.mo3278b()).setWeight(cVar.mo3281e());
                    if (!cVar.mo3282f()) {
                        i4 = 0;
                    }
                    Font build = weight.setSlant(i4).setTtcIndex(cVar.mo3279c()).setFontVariationSettings(cVar.mo3280d()).build();
                    if (builder == null) {
    ...
    public android.graphics.Typeface mo12886c(android.content.Context r11, android.os.CancellationSignal r12, p082e.p109h.p116m.C3670f.C3672b[] r13, int r14) {
        /*
            r10 = this;
        ...
        L_0x0009:
            ...
            android.net.Uri r7 = r6.mo12949d()     // Catch:{ IOException -> 0x0060 }
        ...
        L_0x0020:
            ...
            int r9 = r6.mo12950e()     // Catch:{ all -> 0x0054 }
            android.graphics.fonts.Font$Builder r8 = r8.setWeight(r9)     // Catch:{ all -> 0x0054 }
            boolean r9 = r6.mo12951f()     // Catch:{ all -> 0x0054 }
        ...
        L_0x0035:
            ...
            int r6 = r6.mo12948c()     // Catch:{ all -> 0x0054 }
        ...
        L_0x008b:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: p082e.p109h.p110h.C3632i.mo12886c(android.content.Context, android.os.CancellationSignal, e.h.m.f$b[], int):android.graphics.Typeface");
    }
