...
public final class C3644b {
    ...
    /* renamed from: b */
    private C3645a f11618b;

    /* renamed from: c */
    private Object f11619c;

    /* renamed from: d */
    private boolean f11620d;

    /* renamed from: e.h.l.b$a */
    /* compiled from: CancellationSignal */
    ...
    public void mo12905a() {
        /*
            r4 = this;
            monitor-enter(r4)
            boolean r0 = r4.f11617a     // Catch:{ all -> 0x003e }
            if (r0 == 0) goto L_0x0007
            monitor-exit(r4)     // Catch:{ all -> 0x003e }
            return
        L_0x0007:
            r0 = 1
            r4.f11617a = r0     // Catch:{ all -> 0x003e }
            r4.f11620d = r0     // Catch:{ all -> 0x003e }
            e.h.l.b$a r0 = r4.f11618b     // Catch:{ all -> 0x003e }
            java.lang.Object r1 = r4.f11619c     // Catch:{ all -> 0x003e }
            monitor-exit(r4)     // Catch:{ all -> 0x003e }
            r2 = 0
            if (r0 == 0) goto L_0x001a
            r0.mo3847a()     // Catch:{ all -> 0x0018 }
            goto L_0x001a
        L_0x0018:
            r0 = move-exception
            goto L_0x0028
        ...
        L_0x0028:
            monitor-enter(r4)
            r4.f11620d = r2     // Catch:{ all -> 0x0030 }
        ...
        L_0x0033:
            monitor-enter(r4)
            r4.f11620d = r2     // Catch:{ all -> 0x003b }
        ...
        L_0x003e:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: p082e.p109h.p115l.C3644b.mo12905a():void");
    }

    /* renamed from: b */
    public boolean mo12906b() {
        boolean z;
        synchronized (this) {
            z = this.f11617a;
        }
    ...
    /* renamed from: c */
    public void mo12907c(C3645a aVar) {
        synchronized (this) {
            m15700d();
            if (this.f11618b != aVar) {
                this.f11618b = aVar;
                if (this.f11617a) {
                    if (aVar != null) {
                        aVar.mo3847a();
