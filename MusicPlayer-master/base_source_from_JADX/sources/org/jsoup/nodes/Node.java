...
public abstract class Node implements Cloneable {
    ...
    public String attr(String str) {
        ...
        return str.toLowerCase().startsWith("abs:") ? absUrl(str.substring(4)) : BuildConfig.FLAVOR;
    }
    ...
    public boolean hasAttr(String str) {
        ...
        if (str.startsWith("abs:")) {
            ...
            if (this.attributes.hasKeyIgnoreCase(substring) && !absUrl(substring).equals(BuildConfig.FLAVOR)) {
                return true;
            }
        }
