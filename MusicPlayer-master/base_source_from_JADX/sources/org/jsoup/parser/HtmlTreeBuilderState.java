...
enum HtmlTreeBuilderState {
        ...
        public boolean process(Token token, HtmlTreeBuilder htmlTreeBuilder) {
            ...
            if (token.isComment()) {
                ...
                if (token.isStartTag() && token.asStartTag().normalName().equals("html")) {
                    ...
                    htmlTreeBuilder.transition(HtmlTreeBuilderState.BeforeHead);
                } else if (token.isEndTag() && StringUtil.m50211in(token.asEndTag().normalName(), "head", "body", "html", "br")) {
    ...
    InHead {
        ...
        public boolean process(Token token, HtmlTreeBuilder htmlTreeBuilder) {
            ...
            int i = C959324.$SwitchMap$org$jsoup$parser$Token$TokenType[token.type.ordinal()];
            if (i == 1) {
                htmlTreeBuilder.insert(token.asComment());
            } else if (i == 2) {
                htmlTreeBuilder.error(this);
                ...
                if (StringUtil.m50211in(normalName, "base", "basefont", "bgsound", "command", "link")) {
                ...
                } else if (StringUtil.m50211in(normalName, "noframes", "style")) {
                ...
                } else if (StringUtil.m50211in(normalName2, "body", "html", "br")) {
                    return anythingElse(token, htmlTreeBuilder);
                } else {
                    htmlTreeBuilder.error(this);
                    return false;
        ...
        public boolean process(Token token, HtmlTreeBuilder htmlTreeBuilder) {
            if (token.isDoctype()) {
                ...
                if (token.isEndTag() && token.asEndTag().normalName().equals("noscript")) {
                    ...
                    htmlTreeBuilder.transition(HtmlTreeBuilderState.InHead);
                    return true;
                } else if (HtmlTreeBuilderState.isWhitespace(token) || token.isComment() || (token.isStartTag() && StringUtil.m50211in(token.asStartTag().normalName(), "basefont", "bgsound", "link", "meta", "noframes", "style"))) {
                    return htmlTreeBuilder.process(token, HtmlTreeBuilderState.InHead);
                } else {
                    if (token.isEndTag() && token.asEndTag().normalName().equals("br")) {
                        return anythingElse(token, htmlTreeBuilder);
                    }
                    if ((!token.isStartTag() || !StringUtil.m50211in(token.asStartTag().normalName(), "head", "noscript")) && !token.isEndTag()) {
                        return anythingElse(token, htmlTreeBuilder);
                    }
                    htmlTreeBuilder.error(this);
                    return false;
        ...
        public boolean process(Token token, HtmlTreeBuilder htmlTreeBuilder) {
            ...
            if (HtmlTreeBuilderState.isWhitespace(token)) {
                ...
                if (normalName.equals("body")) {
                    ...
                    return true;
                } else if (StringUtil.m50211in(normalName, "base", "basefont", "bgsound", "link", "meta", "noframes", "script", "style", "title")) {
                    htmlTreeBuilder2.error(this);
                ...
                anythingElse(token, htmlTreeBuilder);
                return true;
            } else if (StringUtil.m50211in(token.asEndTag().normalName(), "body", "html")) {
                anythingElse(token, htmlTreeBuilder);
                return true;
            } else {
                htmlTreeBuilder2.error(this);
    ...
    InBody {
        ...
        public boolean process(Token token, HtmlTreeBuilder htmlTreeBuilder) {
            ...
            Token token2 = token;
            HtmlTreeBuilder htmlTreeBuilder2 = htmlTreeBuilder;
            int i = C959324.$SwitchMap$org$jsoup$parser$Token$TokenType[token2.type.ordinal()];
            boolean z = true;
            if (i == 1) {
                htmlTreeBuilder2.insert(token.asComment());
            } else if (i == 2) {
    ...
    InTable {
        ...
        public boolean anythingElse(Token token, HtmlTreeBuilder htmlTreeBuilder) {
            htmlTreeBuilder.error(this);
            if (!StringUtil.m50211in(htmlTreeBuilder.currentElement().nodeName(), "table", "tbody", "tfoot", "thead", "tr")) {
                return htmlTreeBuilder.process(token, HtmlTreeBuilderState.InBody);
            }
        ...
        public boolean process(Token token, HtmlTreeBuilder htmlTreeBuilder) {
            ...
            if (token.isCharacter()) {
                ...
                if (normalName.equals("caption")) {
                    ...
                    return htmlTreeBuilder2.process(token2);
                } else if (StringUtil.m50211in(normalName, "tbody", "tfoot", "thead")) {
                    htmlTreeBuilder.clearStackToTableContext();
                    htmlTreeBuilder2.insert(asStartTag);
                    htmlTreeBuilder2.transition(HtmlTreeBuilderState.InTableBody);
                } else if (StringUtil.m50211in(normalName, "td", "th", "tr")) {
                ...
                } else if (StringUtil.m50211in(normalName, "style", "script")) {
                    return htmlTreeBuilder2.process(token2, HtmlTreeBuilderState.InHead);
                } else {
                ...
                if (normalName2.equals("table")) {
                    ...
                    return true;
                } else if (!StringUtil.m50211in(normalName2, "body", "caption", "col", "colgroup", "html", "tbody", "td", "tfoot", "th", "thead", "tr")) {
                    return anythingElse(token, htmlTreeBuilder);
                } else {
                    htmlTreeBuilder2.error(this);
                    return false;
    ...
    InTableText {
        /* access modifiers changed from: package-private */
        public boolean process(Token token, HtmlTreeBuilder htmlTreeBuilder) {
            if (C959324.$SwitchMap$org$jsoup$parser$Token$TokenType[token.type.ordinal()] != 5) {
    ...
    InCaption {
        ...
        public boolean process(Token token, HtmlTreeBuilder htmlTreeBuilder) {
            if (!token.isEndTag() || !token.asEndTag().normalName().equals("caption")) {
                if ((token.isStartTag() && StringUtil.m50211in(token.asStartTag().normalName(), "caption", "col", "colgroup", "tbody", "td", "tfoot", "th", "thead", "tr")) || (token.isEndTag() && token.asEndTag().normalName().equals("table"))) {
                    htmlTreeBuilder.error(this);
                    if (htmlTreeBuilder.processEndTag("caption")) {
                        return htmlTreeBuilder.process(token);
                    }
                    return true;
                } else if (!token.isEndTag() || !StringUtil.m50211in(token.asEndTag().normalName(), "body", "col", "colgroup", "html", "tbody", "td", "tfoot", "th", "thead", "tr")) {
                    return htmlTreeBuilder.process(token, HtmlTreeBuilderState.InBody);
                } else {
                    htmlTreeBuilder.error(this);
                    return false;
        ...
        public boolean process(Token token, HtmlTreeBuilder htmlTreeBuilder) {
            ...
            if (i == 3) {
                ...
                if (normalName.equals("tr")) {
                    ...
                    return true;
                } else if (StringUtil.m50211in(normalName, "th", "td")) {
                    htmlTreeBuilder.error(this);
                    htmlTreeBuilder.processStartTag("tr");
                    return htmlTreeBuilder.process(asStartTag);
                } else if (StringUtil.m50211in(normalName, "caption", "col", "colgroup", "tbody", "tfoot", "thead")) {
                ...
                String normalName2 = token.asEndTag().normalName();
                if (StringUtil.m50211in(normalName2, "tbody", "tfoot", "thead")) {
                    ...
                    if (!StringUtil.m50211in(normalName2, "body", "caption", "col", "colgroup", "html", "td", "th", "tr")) {
                        return anythingElse(token, htmlTreeBuilder);
                    }
                    htmlTreeBuilder.error(this);
                    return false;
    ...
    InRow {
        ...
        public boolean process(Token token, HtmlTreeBuilder htmlTreeBuilder) {
            if (token.isStartTag()) {
                Token.StartTag asStartTag = token.asStartTag();
                String normalName = asStartTag.normalName();
                if (StringUtil.m50211in(normalName, "th", "td")) {
                    htmlTreeBuilder.clearStackToTableRowContext();
                    htmlTreeBuilder.insert(asStartTag);
                    htmlTreeBuilder.transition(HtmlTreeBuilderState.InCell);
                    htmlTreeBuilder.insertMarkerToFormattingElements();
                    return true;
                } else if (StringUtil.m50211in(normalName, "caption", "col", "colgroup", "tbody", "tfoot", "thead", "tr")) {
                ...
                if (normalName2.equals("tr")) {
                    ...
                    if (StringUtil.m50211in(normalName2, "tbody", "tfoot", "thead")) {
                        ...
                        return htmlTreeBuilder.process(token);
                    } else if (!StringUtil.m50211in(normalName2, "body", "caption", "col", "colgroup", "html", "td", "th")) {
                        return anythingElse(token, htmlTreeBuilder);
                    } else {
                        htmlTreeBuilder.error(this);
                        return false;
    ...
    InCell {
        ...
        public boolean process(Token token, HtmlTreeBuilder htmlTreeBuilder) {
            if (token.isEndTag()) {
                String normalName = token.asEndTag().normalName();
                if (StringUtil.m50211in(normalName, "td", "th")) {
                    ...
                    htmlTreeBuilder.transition(HtmlTreeBuilderState.InRow);
                    return true;
                } else if (StringUtil.m50211in(normalName, "body", "caption", "col", "colgroup", "html")) {
                    htmlTreeBuilder.error(this);
                    return false;
                } else if (!StringUtil.m50211in(normalName, "table", "tbody", "tfoot", "thead", "tr")) {
                    return anythingElse(token, htmlTreeBuilder);
                } else {
                    if (!htmlTreeBuilder.inTableScope(normalName)) {
                        htmlTreeBuilder.error(this);
            ...
            } else if (!token.isStartTag() || !StringUtil.m50211in(token.asStartTag().normalName(), "caption", "col", "colgroup", "tbody", "td", "tfoot", "th", "thead", "tr")) {
                return anythingElse(token, htmlTreeBuilder);
            } else {
    ...
    InSelect {
        ...
        /* access modifiers changed from: package-private */
        public boolean process(Token token, HtmlTreeBuilder htmlTreeBuilder) {
            switch (C959324.$SwitchMap$org$jsoup$parser$Token$TokenType[token.type.ordinal()]) {
                case 1:
                    htmlTreeBuilder.insert(token.asComment());
                    return true;
                case 2:
                ...
                case 3:
                    ...
                    } else if (StringUtil.m50211in(normalName, "input", "keygen", "textarea")) {
                        htmlTreeBuilder.error(this);
    ...
    InSelectInTable {
        /* access modifiers changed from: package-private */
        public boolean process(Token token, HtmlTreeBuilder htmlTreeBuilder) {
            if (token.isStartTag() && StringUtil.m50211in(token.asStartTag().normalName(), "caption", "table", "tbody", "tfoot", "thead", "tr", "td", "th")) {
                htmlTreeBuilder.error(this);
                htmlTreeBuilder.processEndTag("select");
                return htmlTreeBuilder.process(token);
            } else if (!token.isEndTag() || !StringUtil.m50211in(token.asEndTag().normalName(), "caption", "table", "tbody", "tfoot", "thead", "tr", "td", "th")) {
    ...
    static /* synthetic */ class C959324 {
        ...
        static {
            ...
            L_0x0049:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: org.jsoup.parser.HtmlTreeBuilderState.C959324.<clinit>():void");
        }
    }
