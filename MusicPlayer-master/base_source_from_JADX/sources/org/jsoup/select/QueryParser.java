...
public class QueryParser {
    ...
    /* renamed from: tq */
    private TokenQueue f36732tq;

    private QueryParser(String str) {
        this.query = str;
        this.f36732tq = new TokenQueue(str);
    }
    ...
    private void byAttribute() {
        TokenQueue tokenQueue = new TokenQueue(this.f36732tq.chompBalanced('[', ']'));
    ...
    private void byClass() {
        String consumeCssIdentifier = this.f36732tq.consumeCssIdentifier();
    ...
    private void byId() {
        String consumeCssIdentifier = this.f36732tq.consumeCssIdentifier();
        Validate.notEmpty(consumeCssIdentifier);
        this.evals.add(new Evaluator.C9672Id(consumeCssIdentifier));
    }

    private void byTag() {
        String consumeElementSelector = this.f36732tq.consumeElementSelector();
        Validate.notEmpty(consumeElementSelector);
        if (consumeElementSelector.startsWith("*|")) {
            this.evals.add(new CombiningEvaluator.C9671Or(new Evaluator.Tag(consumeElementSelector.trim().toLowerCase()), new Evaluator.TagEndsWith(consumeElementSelector.replace("*|", ":").trim().toLowerCase())));
            return;
        }
    ...
    private void combinator(char r11) {
        /*
            r10 = this;
            org.jsoup.parser.TokenQueue r0 = r10.f36732tq
            ...
            boolean r5 = r1 instanceof org.jsoup.select.CombiningEvaluator.C9671Or
            if (r5 == 0) goto L_0x003a
            if (r11 == r2) goto L_0x003a
            r5 = r1
            org.jsoup.select.CombiningEvaluator$Or r5 = (org.jsoup.select.CombiningEvaluator.C9671Or) r5
        ...
        L_0x0096:
            ...
            boolean r11 = r1 instanceof org.jsoup.select.CombiningEvaluator.C9671Or
            if (r11 == 0) goto L_0x00a3
            org.jsoup.select.CombiningEvaluator$Or r1 = (org.jsoup.select.CombiningEvaluator.C9671Or) r1
            r1.add(r0)
            r11 = r1
            goto L_0x00ae
        L_0x00a3:
        ...
        L_0x00ae:
            ...
            r0 = r5
            org.jsoup.select.CombiningEvaluator$Or r0 = (org.jsoup.select.CombiningEvaluator.C9671Or) r0
    ...
    private int consumeIndex() {
        String trim = this.f36732tq.chompTo(")").trim();
    ...
    private String consumeSubQuery() {
        ...
        while (!this.f36732tq.isEmpty()) {
            if (this.f36732tq.matches("(")) {
                sb.append("(");
                sb.append(this.f36732tq.chompBalanced('(', ')'));
                sb.append(")");
            } else if (this.f36732tq.matches("[")) {
                sb.append("[");
                sb.append(this.f36732tq.chompBalanced('[', ']'));
                sb.append("]");
            } else if (this.f36732tq.matchesAny(combinators)) {
                break;
            } else {
                sb.append(this.f36732tq.consume());
            }
        }
        return sb.toString();
    }
    ...
    private void contains(boolean z) {
        this.f36732tq.consume(z ? ":containsOwn" : ":contains");
        String unescape = TokenQueue.unescape(this.f36732tq.chompBalanced('(', ')'));
    ...
    private void containsData() {
        this.f36732tq.consume(":containsData");
        String unescape = TokenQueue.unescape(this.f36732tq.chompBalanced('(', ')'));
    ...
    private void cssNthChild(boolean z, boolean z2) {
        String lowerCase = this.f36732tq.chompTo(")").trim().toLowerCase();
    ...
    private void findElements() {
        if (this.f36732tq.matchChomp("#")) {
            byId();
        } else if (this.f36732tq.matchChomp(".")) {
            byClass();
        } else if (this.f36732tq.matchesWord() || this.f36732tq.matches("*|")) {
            byTag();
        } else if (this.f36732tq.matches("[")) {
            byAttribute();
        } else if (this.f36732tq.matchChomp("*")) {
            allElements();
        } else if (this.f36732tq.matchChomp(":lt(")) {
            indexLessThan();
        } else if (this.f36732tq.matchChomp(":gt(")) {
            indexGreaterThan();
        } else if (this.f36732tq.matchChomp(":eq(")) {
            indexEquals();
        } else if (this.f36732tq.matches(":has(")) {
            has();
        } else if (this.f36732tq.matches(":contains(")) {
            contains(false);
        } else if (this.f36732tq.matches(":containsOwn(")) {
            contains(true);
        } else if (this.f36732tq.matches(":containsData(")) {
            containsData();
        } else if (this.f36732tq.matches(":matches(")) {
            matches(false);
        } else if (this.f36732tq.matches(":matchesOwn(")) {
            matches(true);
        } else if (this.f36732tq.matches(":not(")) {
            not();
        } else if (this.f36732tq.matchChomp(":nth-child(")) {
            cssNthChild(false, false);
        } else if (this.f36732tq.matchChomp(":nth-last-child(")) {
            cssNthChild(true, false);
        } else if (this.f36732tq.matchChomp(":nth-of-type(")) {
            cssNthChild(false, true);
        } else if (this.f36732tq.matchChomp(":nth-last-of-type(")) {
            cssNthChild(true, true);
        } else if (this.f36732tq.matchChomp(":first-child")) {
            this.evals.add(new Evaluator.IsFirstChild());
        } else if (this.f36732tq.matchChomp(":last-child")) {
            this.evals.add(new Evaluator.IsLastChild());
        } else if (this.f36732tq.matchChomp(":first-of-type")) {
            this.evals.add(new Evaluator.IsFirstOfType());
        } else if (this.f36732tq.matchChomp(":last-of-type")) {
            this.evals.add(new Evaluator.IsLastOfType());
        } else if (this.f36732tq.matchChomp(":only-child")) {
            this.evals.add(new Evaluator.IsOnlyChild());
        } else if (this.f36732tq.matchChomp(":only-of-type")) {
            this.evals.add(new Evaluator.IsOnlyOfType());
        } else if (this.f36732tq.matchChomp(":empty")) {
            this.evals.add(new Evaluator.IsEmpty());
        } else if (this.f36732tq.matchChomp(":root")) {
            this.evals.add(new Evaluator.IsRoot());
        } else {
            throw new Selector.SelectorParseException("Could not parse query '%s': unexpected token at '%s'", this.query, this.f36732tq.remainder());
        }
    }

    private void has() {
        this.f36732tq.consume(":has");
        String chompBalanced = this.f36732tq.chompBalanced('(', ')');
    ...
    private void matches(boolean z) {
        this.f36732tq.consume(z ? ":matchesOwn" : ":matches");
        String chompBalanced = this.f36732tq.chompBalanced('(', ')');
    ...
    public Evaluator parse() {
        this.f36732tq.consumeWhitespace();
        if (this.f36732tq.matchesAny(combinators)) {
            this.evals.add(new StructuralEvaluator.Root());
            combinator(this.f36732tq.consume());
        } else {
            findElements();
        }
        while (!this.f36732tq.isEmpty()) {
            boolean consumeWhitespace = this.f36732tq.consumeWhitespace();
            if (this.f36732tq.matchesAny(combinators)) {
                combinator(this.f36732tq.consume());
