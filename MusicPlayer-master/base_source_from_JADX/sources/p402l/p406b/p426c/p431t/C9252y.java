...
/* renamed from: l.b.c.t.y */
/* compiled from: ID3v23FieldKey */
public enum C9252y {
    ALBUM("TALB", r7),
    ...
    YEAR("TYER", r7),
    ENGINEER("IPLS", "engineer", r6),
    PRODUCER("IPLS", "producer", r6),
    MIXER("IPLS", "mix", r6),
    DJMIXER("IPLS", "DJ-mix", r6),
    ARRANGER("IPLS", "arranger", r6),
    ...
    private C9252y(String str, C9195i0 i0Var) {
        this.frameId = str;
    ...
    private C9252y(String str, String str2, C9195i0 i0Var) {
        this.frameId = str;
        this.subId = str2;
        this.fieldType = i0Var;
