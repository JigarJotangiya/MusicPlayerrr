...
import coocent.music.player.widget.p276l.C7262a;
import coocent.music.player.widget.p276l.C7263b;
import java.util.HashMap;
import p342g.p343a.p344a.p358i.C8345u;
import p443m.p444a.p447e.p448a.C9332d;

public class VARCRelativeLayout extends RelativeLayout implements Checkable, C7262a {

    /* renamed from: g */
    C7263b f31369g;

    /* renamed from: coocent.music.player.skin.VARCRelativeLayout$a */
    static /* synthetic */ class C7093a {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f31370a     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f31370a     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f31370a     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                int[] r0 = f31370a     // Catch:{ NoSuchFieldError -> 0x003e }
            ...
            L_0x003e:
                int[] r0 = f31370a     // Catch:{ NoSuchFieldError -> 0x0049 }
            ...
            L_0x0049:
                int[] r0 = f31370a     // Catch:{ NoSuchFieldError -> 0x0054 }
            ...
            L_0x0054:
                int[] r0 = f31370a     // Catch:{ NoSuchFieldError -> 0x0060 }
            ...
            L_0x0060:
                int[] r0 = f31370a     // Catch:{ NoSuchFieldError -> 0x006c }
            ...
            L_0x006c:
                int[] r0 = f31370a     // Catch:{ NoSuchFieldError -> 0x0078 }
            ...
            L_0x0078:
                int[] r0 = f31370a     // Catch:{ NoSuchFieldError -> 0x0084 }
            ...
            L_0x0084:
                int[] r0 = f31370a     // Catch:{ NoSuchFieldError -> 0x0090 }
            ...
            L_0x0090:
                int[] r0 = f31370a     // Catch:{ NoSuchFieldError -> 0x009c }
            ...
            L_0x009c:
                int[] r0 = f31370a     // Catch:{ NoSuchFieldError -> 0x00a8 }
            ...
            L_0x00a8:
                int[] r0 = f31370a     // Catch:{ NoSuchFieldError -> 0x00b4 }
            ...
            L_0x00b4:
                int[] r0 = f31370a     // Catch:{ NoSuchFieldError -> 0x00c0 }
            ...
            L_0x00c0:
                int[] r0 = f31370a     // Catch:{ NoSuchFieldError -> 0x00cc }
            ...
            L_0x00cc:
                int[] r0 = f31370a     // Catch:{ NoSuchFieldError -> 0x00d8 }
            ...
            L_0x00d8:
                int[] r0 = f31370a     // Catch:{ NoSuchFieldError -> 0x00e4 }
            ...
            L_0x00e4:
                int[] r0 = f31370a     // Catch:{ NoSuchFieldError -> 0x00f0 }
            ...
            L_0x00f0:
                int[] r0 = f31370a     // Catch:{ NoSuchFieldError -> 0x00fc }
            ...
            L_0x00fc:
                int[] r0 = f31370a     // Catch:{ NoSuchFieldError -> 0x0108 }
            ...
            L_0x0108:
                int[] r0 = f31370a     // Catch:{ NoSuchFieldError -> 0x0114 }
            ...
            L_0x0114:
                int[] r0 = f31370a     // Catch:{ NoSuchFieldError -> 0x0120 }
            ...
            L_0x0120:
                int[] r0 = f31370a     // Catch:{ NoSuchFieldError -> 0x012c }
            ...
            L_0x012c:
                int[] r0 = f31370a     // Catch:{ NoSuchFieldError -> 0x0138 }
            ...
            L_0x0138:
                int[] r0 = f31370a     // Catch:{ NoSuchFieldError -> 0x0144 }
            ...
            L_0x0144:
                int[] r0 = f31370a     // Catch:{ NoSuchFieldError -> 0x0150 }
            ...
            L_0x0150:
                int[] r0 = f31370a     // Catch:{ NoSuchFieldError -> 0x015c }
            ...
            L_0x015c:
                int[] r0 = f31370a     // Catch:{ NoSuchFieldError -> 0x0168 }
            ...
            L_0x0168:
                int[] r0 = f31370a     // Catch:{ NoSuchFieldError -> 0x0174 }
            ...
            L_0x0174:
                int[] r0 = f31370a     // Catch:{ NoSuchFieldError -> 0x0180 }
            ...
            L_0x0180:
                int[] r0 = f31370a     // Catch:{ NoSuchFieldError -> 0x018c }
            ...
            L_0x018c:
                int[] r0 = f31370a     // Catch:{ NoSuchFieldError -> 0x0198 }
            ...
            L_0x0198:
                int[] r0 = f31370a     // Catch:{ NoSuchFieldError -> 0x01a4 }
            ...
            L_0x01a4:
                int[] r0 = f31370a     // Catch:{ NoSuchFieldError -> 0x01b0 }
            ...
            L_0x01b0:
                int[] r0 = f31370a     // Catch:{ NoSuchFieldError -> 0x01bc }
            ...
            L_0x01bc:
                int[] r0 = f31370a     // Catch:{ NoSuchFieldError -> 0x01c8 }
            ...
            L_0x01c8:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: coocent.music.player.skin.VARCRelativeLayout.C7093a.<clinit>():void");
        }
    }
    ...
    public void dispatchDraw(Canvas canvas) {
        canvas.saveLayer(this.f31369g.f32066k, (Paint) null, 31);
        super.dispatchDraw(canvas);
        this.f31369g.mo27846c(canvas);
        canvas.restore();
    }
    ...
    public void draw(Canvas canvas) {
        if (this.f31369g.f32064i) {
            canvas.save();
            canvas.clipPath(this.f31369g.f32057b);
            super.draw(canvas);
            canvas.restore();
            return;
        }
    ...
    public void drawableStateChanged() {
        ...
        this.f31369g.mo27844a(this);
    }

    public float getBottomLeftRadius() {
        return this.f31369g.f32056a[4];
    }

    public float getBottomRightRadius() {
        return this.f31369g.f32056a[6];
    }

    public int getStrokeColor() {
        return this.f31369g.f32061f;
    }

    public int getStrokeWidth() {
        return this.f31369g.f32063h;
    }

    public float getTopLeftRadius() {
        return this.f31369g.f32056a[0];
    }

    public float getTopRightRadius() {
        return this.f31369g.f32056a[2];
    }

    public void invalidate() {
        C7263b bVar = this.f31369g;
        if (bVar != null) {
            bVar.mo27848e(this);
        }
        super.invalidate();
    ...
    public void onSizeChanged(int i, int i2, int i3, int i4) {
        ...
        this.f31369g.mo27847d(this, i, i2);
    }
    ...
    public void setAttributeSet(AttributeSet attributeSet) {
        ...
        for (int i = 0; i < attributeCount; i++) {
            ...
            if (aVar != null) {
                ...
                int i2 = C7093a.f31370a[aVar.ordinal()];
                if (i2 == 1) {
    ...
    public void setBottomLeftRadius(int i) {
        float[] fArr = this.f31369g.f32056a;
        float f = (float) i;
        fArr[6] = f;
        fArr[7] = f;
        invalidate();
    ...
    public void setChecked(boolean z) {
        ...
        if (bVar.f32067l != z) {
            ...
            C7263b bVar2 = this.f31369g;
            C7263b.C7264a aVar = bVar2.f32068m;
            if (aVar != null) {
                aVar.mo27849a(this, bVar2.f32067l);
            }
        }
    }

    public void setClipBackground(boolean z) {
        this.f31369g.f32064i = z;
        invalidate();
    }

    public void setOnCheckedChangeListener(C7263b.C7264a aVar) {
        this.f31369g.f32068m = aVar;
    }
    ...
    public void setRoundAsCircle(boolean z) {
        this.f31369g.f32059d = z;
        invalidate();
    }

    public void setStrokeColor(int i) {
        this.f31369g.f32061f = i;
        invalidate();
    }

    public void setStrokeWidth(int i) {
        this.f31369g.f32063h = i;
        invalidate();
    }
    ...
    public RelativeLayout.LayoutParams generateLayoutParams(AttributeSet attributeSet) {
        ...
        for (int i = 0; i < attributeCount; i++) {
            ...
            if (aVar != null) {
                switch (C7093a.f31370a[aVar.ordinal()]) {
                    case 4:
                        String attributeValue = attributeSet.getAttributeValue(i);
                    ...
                    case 20:
                        layoutParams.leftMargin = C7102b.m40441e().mo27287a(attributeSet.getAttributeValue(i));
                        break;
                    case 21:
                        layoutParams.rightMargin = C7102b.m40441e().mo27287a(attributeSet.getAttributeValue(i));
                        break;
                    case 22:
                        layoutParams.setMarginStart(C7102b.m40441e().mo27287a(attributeSet.getAttributeValue(i)));
                        break;
                    case 23:
                        layoutParams.setMarginEnd(C7102b.m40441e().mo27287a(attributeSet.getAttributeValue(i)));
                        break;
                    case 24:
                        layoutParams.topMargin = C7102b.m40441e().mo27287a(attributeSet.getAttributeValue(i));
                        break;
                    case 25:
                        layoutParams.bottomMargin = C7102b.m40441e().mo27287a(attributeSet.getAttributeValue(i));
                        break;
                    case 26:
