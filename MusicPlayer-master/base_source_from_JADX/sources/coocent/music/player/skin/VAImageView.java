...
public class VAImageView extends SkinCompatImageView {
    ...
    /* renamed from: coocent.music.player.skin.VAImageView$a */
    static /* synthetic */ class C7089a {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f31364a     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f31364a     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f31364a     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                int[] r0 = f31364a     // Catch:{ NoSuchFieldError -> 0x003e }
            ...
            L_0x003e:
                int[] r0 = f31364a     // Catch:{ NoSuchFieldError -> 0x0049 }
            ...
            L_0x0049:
                int[] r0 = f31364a     // Catch:{ NoSuchFieldError -> 0x0054 }
            ...
            L_0x0054:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: coocent.music.player.skin.VAImageView.C7089a.<clinit>():void");
        }
    }

    public VAImageView(Context context, AttributeSet attributeSet) {
        super(context);
        mo27240d(context, attributeSet);
    }

    /* renamed from: d */
    public void mo27240d(Context context, AttributeSet attributeSet) {
        ...
        for (int i = 0; i < attributeCount; i++) {
            ...
            if (aVar != null) {
                switch (C7089a.f31364a[aVar.ordinal()]) {
                    case 1:
                    ...
                    case 7:
                        ...
                        if (!attributeValue5.equals("centerCrop")) {
                            if (!attributeValue5.equals("fitCenter")) {
                                break;
                            } else {
