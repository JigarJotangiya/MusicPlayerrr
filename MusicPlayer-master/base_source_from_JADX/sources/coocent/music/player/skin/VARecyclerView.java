...
public class VARecyclerView extends RecyclerView {

    /* renamed from: R0 */
    Context f31371R0;

    /* renamed from: coocent.music.player.skin.VARecyclerView$a */
    static /* synthetic */ class C7094a {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f31372a     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f31372a     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f31372a     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                int[] r0 = f31372a     // Catch:{ NoSuchFieldError -> 0x003e }
            ...
            L_0x003e:
                int[] r0 = f31372a     // Catch:{ NoSuchFieldError -> 0x0049 }
            ...
            L_0x0049:
                int[] r0 = f31372a     // Catch:{ NoSuchFieldError -> 0x0054 }
            ...
            L_0x0054:
                int[] r0 = f31372a     // Catch:{ NoSuchFieldError -> 0x0060 }
            ...
            L_0x0060:
                int[] r0 = f31372a     // Catch:{ NoSuchFieldError -> 0x006c }
                coocent.music.player.skin.b.a r1 = coocent.music.player.skin.p273b.C7101a.id     // Catch:{ NoSuchFieldError -> 0x006c }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x006c }
                r2 = 9
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x006c }
            L_0x006c:
                int[] r0 = f31372a     // Catch:{ NoSuchFieldError -> 0x0078 }
                coocent.music.player.skin.b.a r1 = coocent.music.player.skin.p273b.C7101a.splitMotionEvents     // Catch:{ NoSuchFieldError -> 0x0078 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0078 }
                r2 = 10
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0078 }
            L_0x0078:
                int[] r0 = f31372a     // Catch:{ NoSuchFieldError -> 0x0084 }
                coocent.music.player.skin.b.a r1 = coocent.music.player.skin.p273b.C7101a.background     // Catch:{ NoSuchFieldError -> 0x0084 }
            ...
            L_0x0084:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: coocent.music.player.skin.VARecyclerView.C7094a.<clinit>():void");
        }
    }

    public VARecyclerView(Context context, AttributeSet attributeSet) {
        super(context);
        setAttributeSet(attributeSet);
        this.f31371R0 = context;
    ...
    public RecyclerView.LayoutParams generateLayoutParams(AttributeSet attributeSet) {
        ...
        setLayoutManager(new LinearLayoutManager(this.f31371R0));
        RecyclerView.LayoutParams layoutParams = (RecyclerView.LayoutParams) generateDefaultLayoutParams();
        ...
        for (int i5 = 0; i5 < attributeCount; i5++) {
            ...
            if (aVar != null) {
                switch (C7094a.f31372a[aVar.ordinal()]) {
                    case 1:
