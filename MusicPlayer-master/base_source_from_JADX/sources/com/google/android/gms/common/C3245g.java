...
public class C3245g {
    ...
    /* renamed from: a */
    public static final int f10501a = 12451000;

    /* renamed from: b */
    static final AtomicBoolean f10502b = new AtomicBoolean();

    /* renamed from: c */
    private static final AtomicBoolean f10503c = new AtomicBoolean();

    @Deprecated
    /* renamed from: a */
    public static int m14045a(@RecentlyNonNull Context context) {
        try {
    ...
    @Deprecated
    /* renamed from: b */
    public static String m14046b(int i) {
        return ConnectionResult.m13753z0(i);
    }

    @RecentlyNullable
    /* renamed from: c */
    public static Context m14047c(@RecentlyNonNull Context context) {
        try {
    ...
    @RecentlyNullable
    /* renamed from: d */
    public static Resources m14048d(@RecentlyNonNull Context context) {
        try {
    ...
    public static int m14049e(@androidx.annotation.RecentlyNonNull android.content.Context r10, int r11) {
        /*
            java.lang.String r0 = "GooglePlayServicesUtil"
            android.content.res.Resources r1 = r10.getResources()     // Catch:{ all -> 0x000c }
            int r2 = com.google.android.gms.common.C3247i.common_google_play_services_unknown_issue     // Catch:{ all -> 0x000c }
        ...
        L_0x0011:
            ...
            java.util.concurrent.atomic.AtomicBoolean r1 = f10503c
            boolean r1 = r1.get()
            if (r1 == 0) goto L_0x0026
            goto L_0x003d
        L_0x0026:
            int r1 = com.google.android.gms.common.internal.C3291k0.m14231a(r10)
        ...
        L_0x0037:
            ...
            throw r10
        L_0x003d:
            boolean r1 = com.google.android.gms.common.util.C3363h.m14457g(r10)
            r3 = 1
            r4 = 0
            if (r1 != 0) goto L_0x004d
            boolean r1 = com.google.android.gms.common.util.C3363h.m14459i(r10)
            if (r1 != 0) goto L_0x004d
            r1 = 1
            goto L_0x004e
        L_0x004d:
        ...
        L_0x0052:
            r5 = 0
        L_0x0053:
            com.google.android.gms.common.internal.C3292l.m14233a(r5)
        ...
        L_0x007d:
            ...
            com.google.android.gms.common.C3246h.m14054a(r10)
            boolean r10 = com.google.android.gms.common.C3246h.m14056c(r9, r3)
        ...
        L_0x009a:
            ...
            com.google.android.gms.common.internal.C3292l.m14240h(r8)
            boolean r10 = com.google.android.gms.common.C3246h.m14056c(r8, r3)
        ...
        L_0x00d3:
            ...
            int r10 = com.google.android.gms.common.util.C3372q.m14481a(r10)
            int r1 = com.google.android.gms.common.util.C3372q.m14481a(r11)
        ...
        L_0x013d:
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.common.C3245g.m14049e(android.content.Context, int):int");
    }

    @Deprecated
    /* renamed from: f */
    public static boolean m14050f(@RecentlyNonNull Context context, int i) {
        if (i == 18) {
            return true;
        }
        if (i == 1) {
            return m14053i(context, "com.google.android.gms");
        }
        return false;
    }
    ...
    @TargetApi(18)
    /* renamed from: g */
    public static boolean m14051g(@RecentlyNonNull Context context) {
        if (!C3369n.m14472d()) {
            return false;
        }
    ...
    @Deprecated
    /* renamed from: h */
    public static boolean m14052h(int i) {
        return i == 1 || i == 2 || i == 3 || i == 9;
    }

    @TargetApi(21)
    /* renamed from: i */
    static boolean m14053i(Context context, String str) {
        ...
        try {
            ...
            return applicationInfo.enabled && !m14051g(context);
