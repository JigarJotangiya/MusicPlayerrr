...
public final class C4971cm {

    /* renamed from: a */
    public final List<byte[]> f15025a;
    ...
    private C4971cm(List<byte[]> list, int i, int i2, int i3, float f) {
        this.f15025a = list;
        this.f15026b = i;
        this.f15027c = f;
    }
    ...
    public static com.google.android.gms.internal.ads.C4971cm m21976a(com.google.android.gms.internal.ads.C5600tl r17) throws com.google.android.gms.internal.ads.C5445pe {
        /*
            r0 = 4
            r1 = r17
            r1.mo21104w(r0)     // Catch:{ ArrayIndexOutOfBoundsException -> 0x01b1 }
            int r0 = r17.mo21088g()     // Catch:{ ArrayIndexOutOfBoundsException -> 0x01b1 }
            r2 = 3
            r0 = r0 & r2
            r3 = 1
            int r6 = r0 + 1
        ...
        L_0x001e:
            ...
            byte[] r8 = m21977b(r17)     // Catch:{ ArrayIndexOutOfBoundsException -> 0x01b1 }
            r5.add(r8)     // Catch:{ ArrayIndexOutOfBoundsException -> 0x01b1 }
            int r7 = r7 + 1
            goto L_0x001e
        L_0x002a:
            int r7 = r17.mo21088g()     // Catch:{ ArrayIndexOutOfBoundsException -> 0x01b1 }
            r8 = 0
        L_0x002f:
            if (r8 >= r7) goto L_0x003b
            byte[] r9 = m21977b(r17)     // Catch:{ ArrayIndexOutOfBoundsException -> 0x01b1 }
        ...
        L_0x003b:
            ...
            com.google.android.gms.internal.ads.ul r8 = new com.google.android.gms.internal.ads.ul     // Catch:{ ArrayIndexOutOfBoundsException -> 0x01b1 }
            r8.<init>(r1, r6, r0)     // Catch:{ ArrayIndexOutOfBoundsException -> 0x01b1 }
            r0 = 8
            r8.mo21305d(r0)     // Catch:{ ArrayIndexOutOfBoundsException -> 0x01b1 }
            int r1 = r8.mo21302a(r0)     // Catch:{ ArrayIndexOutOfBoundsException -> 0x01b1 }
            r9 = 16
            r8.mo21305d(r9)     // Catch:{ ArrayIndexOutOfBoundsException -> 0x01b1 }
            r8.mo21304c()     // Catch:{ ArrayIndexOutOfBoundsException -> 0x01b1 }
            r10 = 100
        ...
        L_0x008c:
            ...
            goto L_0x00dc
        L_0x008e:
            int r1 = r8.mo21304c()     // Catch:{ ArrayIndexOutOfBoundsException -> 0x01b1 }
            if (r1 != r2) goto L_0x0099
            r8.mo21306e()     // Catch:{ ArrayIndexOutOfBoundsException -> 0x01b1 }
            r10 = 3
            goto L_0x009a
        L_0x0099:
            r10 = r1
        L_0x009a:
            r8.mo21304c()     // Catch:{ ArrayIndexOutOfBoundsException -> 0x01b1 }
            r8.mo21304c()     // Catch:{ ArrayIndexOutOfBoundsException -> 0x01b1 }
            r8.mo21305d(r3)     // Catch:{ ArrayIndexOutOfBoundsException -> 0x01b1 }
            boolean r11 = r8.mo21306e()     // Catch:{ ArrayIndexOutOfBoundsException -> 0x01b1 }
        ...
        L_0x00b1:
            ...
            boolean r12 = r8.mo21306e()     // Catch:{ ArrayIndexOutOfBoundsException -> 0x01b1 }
        ...
        L_0x00c6:
            ...
            int r14 = r8.mo21303b()     // Catch:{ ArrayIndexOutOfBoundsException -> 0x01b1 }
            int r14 = r14 + r15
            int r14 = r14 + 256
            int r14 = r14 % 256
        L_0x00d3:
        ...
        L_0x00dc:
            r8.mo21304c()     // Catch:{ ArrayIndexOutOfBoundsException -> 0x01b1 }
            int r10 = r8.mo21304c()     // Catch:{ ArrayIndexOutOfBoundsException -> 0x01b1 }
        ...
        L_0x00e9:
            ...
            r8.mo21306e()     // Catch:{ ArrayIndexOutOfBoundsException -> 0x01b1 }
            r8.mo21303b()     // Catch:{ ArrayIndexOutOfBoundsException -> 0x01b1 }
            r8.mo21303b()     // Catch:{ ArrayIndexOutOfBoundsException -> 0x01b1 }
            int r10 = r8.mo21304c()     // Catch:{ ArrayIndexOutOfBoundsException -> 0x01b1 }
        ...
        L_0x0104:
            r8.mo21304c()     // Catch:{ ArrayIndexOutOfBoundsException -> 0x01b1 }
            r8.mo21305d(r3)     // Catch:{ ArrayIndexOutOfBoundsException -> 0x01b1 }
            int r4 = r8.mo21304c()     // Catch:{ ArrayIndexOutOfBoundsException -> 0x01b1 }
            int r4 = r4 + r3
            int r10 = r8.mo21304c()     // Catch:{ ArrayIndexOutOfBoundsException -> 0x01b1 }
            int r10 = r10 + r3
            boolean r11 = r8.mo21306e()     // Catch:{ ArrayIndexOutOfBoundsException -> 0x01b1 }
        ...
        L_0x0121:
            ...
            int r11 = r8.mo21304c()     // Catch:{ ArrayIndexOutOfBoundsException -> 0x01b1 }
            int r13 = r8.mo21304c()     // Catch:{ ArrayIndexOutOfBoundsException -> 0x01b1 }
            int r14 = r8.mo21304c()     // Catch:{ ArrayIndexOutOfBoundsException -> 0x01b1 }
            int r15 = r8.mo21304c()     // Catch:{ ArrayIndexOutOfBoundsException -> 0x01b1 }
        ...
        L_0x014e:
            ...
            int r10 = r10 - r14
        L_0x0156:
            boolean r1 = r8.mo21306e()     // Catch:{ ArrayIndexOutOfBoundsException -> 0x01b1 }
            if (r1 == 0) goto L_0x019c
            boolean r1 = r8.mo21306e()     // Catch:{ ArrayIndexOutOfBoundsException -> 0x01b1 }
            if (r1 == 0) goto L_0x019c
            int r0 = r8.mo21302a(r0)     // Catch:{ ArrayIndexOutOfBoundsException -> 0x01b1 }
            r1 = 255(0xff, float:3.57E-43)
            if (r0 != r1) goto L_0x017b
            int r0 = r8.mo21302a(r9)     // Catch:{ ArrayIndexOutOfBoundsException -> 0x01b1 }
            int r1 = r8.mo21302a(r9)     // Catch:{ ArrayIndexOutOfBoundsException -> 0x01b1 }
        ...
        L_0x017b:
            ...
            float[] r1 = com.google.android.gms.internal.ads.C5526rl.f22892b     // Catch:{ ArrayIndexOutOfBoundsException -> 0x01b1 }
        ...
        L_0x01a4:
            com.google.android.gms.internal.ads.cm r0 = new com.google.android.gms.internal.ads.cm     // Catch:{ ArrayIndexOutOfBoundsException -> 0x01b1 }
            r4 = r0
        ...
        L_0x01b1:
            ...
            throw r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.C4971cm.m21976a(com.google.android.gms.internal.ads.tl):com.google.android.gms.internal.ads.cm");
    }

    /* renamed from: b */
    private static byte[] m21977b(C5600tl tlVar) {
        int j = tlVar.mo21091j();
        int c = tlVar.mo21084c();
        tlVar.mo21104w(j);
        return C5341ml.m27305b(tlVar.f23918a, c, j);
    }
}
