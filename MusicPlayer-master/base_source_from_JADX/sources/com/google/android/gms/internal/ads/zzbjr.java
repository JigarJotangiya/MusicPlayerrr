...
public final class zzbjr extends ContentProvider {
    public final void attachInfo(Context context, ProviderInfo providerInfo) {
        ...
        Bundle bundle = null;
        try {
            bundle = C3334c.m14368a(context).mo11910c(context.getPackageName(), 128).metaData;
        } catch (NullPointerException e) {
            ul0.m31860e("Failed to load metadata: Null pointer exception.", e);
        } catch (PackageManager.NameNotFoundException e2) {
            ul0.m31860e("Failed to load metadata: Package name not found.", e2);
        }
        va0 a = va0.m32249a();
        if (bundle == null) {
            ul0.m31859d("Metadata was null.");
        } else {
            try {
                            ...
                            if (str2 == null || str2.matches("^/\\d+~.+$")) {
                                if (bool == null || !bool.booleanValue()) {
                                    if (!TextUtils.isEmpty(str3)) {
                                        ...
                                        ul0.m31857b(valueOf.length() != 0 ? "The Google Mobile Ads SDK is integrated by ".concat(valueOf) : new String("The Google Mobile Ads SDK is integrated by "));
                                    } else {
