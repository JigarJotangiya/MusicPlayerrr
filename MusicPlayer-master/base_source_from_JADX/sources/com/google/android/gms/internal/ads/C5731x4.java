...
public final class C5731x4 {
    /* renamed from: a */
    public static X509Certificate[][] m33551a(String str) throws C5620u4, SecurityException, IOException {
        ByteBuffer byteBuffer;
        int limit;
        int position;
        RandomAccessFile randomAccessFile = new RandomAccessFile(str, "r");
        try {
            Pair<ByteBuffer, Long> c = C5768y4.m34019c(randomAccessFile);
            if (c != null) {
                ...
                if (j >= 0) {
                    ...
                    if (randomAccessFile.readInt() == 1347094023) {
                        throw new C5620u4("ZIP64 APK not supported");
                    }
                }
                long a = C5768y4.m34017a(byteBuffer2);
                if (a >= longValue) {
                    ...
                    sb.append(longValue);
                    throw new C5620u4(sb.toString());
                } else if (C5768y4.m34018b(byteBuffer2) + a != longValue) {
                    throw new C5620u4("ZIP Central Directory is not immediately followed by End of Central Directory");
                } else if (a >= 32) {
                    ...
                    if (allocate.getLong(8) == 2334950737559900225L && allocate.getLong(16) == 3617552046287187010L) {
                        ...
                        if (j2 < ((long) allocate.capacity()) || j2 > 2147483639) {
                            ...
                            sb2.append(j2);
                            throw new C5620u4(sb2.toString());
                        }
                        int i2 = (int) (8 + j2);
                        long j3 = a - ((long) i2);
                        if (j3 >= 0) {
                                            ...
                                            while (slice.hasRemaining()) {
                                                ...
                                                if (slice.remaining() >= 8) {
                                                    ...
                                                    if (j5 < 4 || j5 > 2147483647L) {
                                                        ...
                                                        sb3.append(j5);
                                                        throw new C5620u4(sb3.toString());
                                                    }
                                                    int i3 = (int) j5;
                                                    ...
                                                    if (i3 > slice.remaining()) {
                                                        ...
                                                        throw new C5620u4(sb4.toString());
                                                    } else if (slice.getInt() == 1896449818) {
                                                        X509Certificate[][] l = m33562l(randomAccessFile.getChannel(), new C5583t4(m33555e(slice, i3 - 4), longValue2, a, longValue, byteBuffer2, (C5435p4) null));
                                                    ...
                                                    sb5.append(i);
                                                    throw new C5620u4(sb5.toString());
                                                }
                                            }
                                            throw new C5620u4("No APK Signature Scheme v2 block in APK Signing Block");
                                        }
                ...
                sb11.append(length);
                sb11.append(" bytes");
                throw new C5620u4(sb11.toString());
            }
        } catch (Throwable th) {
            try {
                randomAccessFile.close();
    ...
    /* renamed from: b */
    private static int m33552b(int i) {
        if (i == 1) {
            return 32;
        }
        if (i == 2) {
    ...
    /* renamed from: c */
    private static int m33553c(int i) {
        if (i == 513) {
            return 1;
        }
        if (i == 514) {
    ...
    /* renamed from: d */
    private static String m33554d(int i) {
        if (i == 1) {
            return "SHA-256";
        }
        if (i == 2) {
    ...
    /* renamed from: e */
    private static ByteBuffer m33555e(ByteBuffer byteBuffer, int i) throws BufferUnderflowException {
        if (i >= 0) {
    ...
    /* renamed from: f */
    private static ByteBuffer m33556f(ByteBuffer byteBuffer) throws IOException {
        if (byteBuffer.remaining() >= 4) {
            int i = byteBuffer.getInt();
            if (i < 0) {
                throw new IllegalArgumentException("Negative length");
            } else if (i <= byteBuffer.remaining()) {
                return m33555e(byteBuffer, i);
            } else {
    ...
    /* renamed from: g */
    private static void m33557g(int i, byte[] bArr, int i2) {
        bArr[1] = (byte) (i & 255);
        bArr[2] = (byte) ((i >>> 8) & 255);
    ...
    /* renamed from: h */
    private static void m33558h(Map<Integer, byte[]> map, FileChannel fileChannel, long j, long j2, long j3, ByteBuffer byteBuffer) throws SecurityException {
        if (!map.isEmpty()) {
            C5546s4 s4Var = new C5546s4(fileChannel, 0, j);
            C5546s4 s4Var2 = new C5546s4(fileChannel, j2, j3 - j2);
            ByteBuffer duplicate = byteBuffer.duplicate();
            duplicate.order(ByteOrder.LITTLE_ENDIAN);
            long j4 = j;
            C5768y4.m34020d(duplicate, j);
            C5472q4 q4Var = new C5472q4(duplicate);
            int size = map.size();
            ...
            try {
                byte[][] k = m33561k(iArr, new C5509r4[]{s4Var, s4Var2, q4Var});
                while (i < size) {
                    int i3 = iArr[i];
                    ...
                    if (MessageDigest.isEqual(map.get(Integer.valueOf(i3)), k[i])) {
                        ...
                        throw new SecurityException(m33554d(i3).concat(" digest of contents did not verify"));
                    }
                }
    ...
    /* renamed from: i */
    private static byte[] m33559i(ByteBuffer byteBuffer) throws IOException {
        int i = byteBuffer.getInt();
        if (i < 0) {
    ...
    /* renamed from: j */
    private static X509Certificate[] m33560j(ByteBuffer byteBuffer, Map<Integer, byte[]> map, CertificateFactory certificateFactory) throws SecurityException, IOException {
        String str;
        Pair pair;
        String str2;
        String str3;
        ByteBuffer f = m33556f(byteBuffer);
        ByteBuffer f2 = m33556f(byteBuffer);
        byte[] i = m33559i(byteBuffer);
        ...
        if (i2 != -1) {
            ...
            try {
                ...
                if (instance.verify(bArr2)) {
                    f.clear();
                    ByteBuffer f4 = m33556f(f);
                    ArrayList arrayList2 = new ArrayList();
                    int i5 = 0;
                    while (f4.hasRemaining()) {
                        i5++;
                        try {
                            ByteBuffer f5 = m33556f(f4);
                            if (f5.remaining() >= 8) {
                                int i6 = f5.getInt();
                    ...
                    if (arrayList.equals(arrayList2)) {
                        ...
                        if (put == null || MessageDigest.isEqual(put, bArr)) {
                            ...
                            while (f6.hasRemaining()) {
                                ...
                                byte[] i8 = m33559i(f6);
                                try {
                                    arrayList3.add(new C5657v4((X509Certificate) certificateFactory.generateCertificate(new ByteArrayInputStream(i8)), i8));
                            ...
                            throw new SecurityException(m33554d(c3).concat(" contents digest does not match the digest specified by a preceding signer"));
                        }
                    } else {
    ...
    /* renamed from: k */
    private static byte[][] m33561k(int[] iArr, C5509r4[] r4VarArr) throws DigestException {
        long j;
        int i;
        int length;
        int[] iArr2 = iArr;
        ...
        while (true) {
            ...
            j3 += (r4VarArr[i3].zza() + 1048575) / 1048576;
            i3++;
        }
        if (j3 < 2097151) {
            int i4 = (int) j3;
            ...
            while (true) {
                ...
                byte[] bArr2 = new byte[((m33552b(iArr2[i5]) * i4) + 5)];
                bArr2[0] = 90;
                m33557g(i4, bArr2, 1);
                bArr[i5] = bArr2;
                i5++;
            ...
            for (i = 3; i7 < i; i = 3) {
                ...
                while (zza > j2) {
                    ...
                    long j5 = j4;
                    try {
                        r4Var.mo20390a(messageDigestArr, j5, min);
                        byte[] bArr4 = bArr3;
                        int i10 = 0;
                        while (i10 < iArr2.length) {
                            int i11 = iArr2[i10];
                            C5509r4 r4Var2 = r4Var;
                            byte[] bArr5 = bArr[i10];
                            int b = m33552b(i11);
                            int i12 = length;
    ...
    /* renamed from: l */
    private static X509Certificate[][] m33562l(FileChannel fileChannel, C5583t4 t4Var) throws SecurityException {
        HashMap hashMap = new HashMap();
        ArrayList arrayList = new ArrayList();
        try {
            CertificateFactory instance = CertificateFactory.getInstance("X.509");
            try {
                ByteBuffer f = m33556f(t4Var.f23736a);
                int i = 0;
                while (f.hasRemaining()) {
                    i++;
                    try {
                        arrayList.add(m33560j(m33556f(f), hashMap, instance));
                ...
                if (i <= 0) {
                    ...
                    m33558h(hashMap, fileChannel, t4Var.f23737b, t4Var.f23738c, t4Var.f23739d, t4Var.f23740e);
