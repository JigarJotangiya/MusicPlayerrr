...
public final class vj3 {
    ...
    /* renamed from: a */
    private final ECPublicKey f24820a;

    public vj3(ECPublicKey eCPublicKey) {
        this.f24820a = eCPublicKey;
    }

    /* renamed from: a */
    public final uj3 mo21558a(String str, byte[] bArr, byte[] bArr2, int i, int i2) throws GeneralSecurityException {
        ...
        try {
            ...
            wj3.m33189c(w, eCPrivateKey.getParams().getCurve());
            PublicKey generatePublic = yj3.f26382i.mo22204a("EC").generatePublic(new ECPublicKeySpec(w, eCPrivateKey.getParams()));
            KeyAgreement a = yj3.f26380g.mo22204a("ECDH");
            a.init(eCPrivateKey);
            int i6 = 1;
            try {
                ...
                if (bigInteger2.signum() == -1 || bigInteger2.compareTo(wj3.m33187a(curve)) >= 0) {
                    throw new GeneralSecurityException("shared secret is out of range");
                }
                BigInteger a2 = wj3.m33187a(curve);
                ...
                if (a2.signum() == 1) {
                    ...
                    wj3.m33189c(w2, curve2);
                    int bitLength2 = (wj3.m33187a(curve2).subtract(BigInteger.ONE).bitLength() + 7) / 8;
                    int i8 = i2 - 1;
                    if (i8 != 0) {
                        if (i8 != 2) {
                            int i9 = bitLength2 + 1;
                    ...
                    byte[] b2 = mj3.m27285b(bArr6);
                    Mac a3 = yj3.f26379f.mo22204a(str2);
