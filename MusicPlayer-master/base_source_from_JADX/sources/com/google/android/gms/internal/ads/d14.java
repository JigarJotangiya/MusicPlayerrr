...
public final class d14 {
    ...
    /* renamed from: a */
    private static final Pattern f15455a = Pattern.compile("^\\D?(\\d+)$");

    /* renamed from: b */
    private static final HashMap<v04, List<m04>> f15456b = new HashMap<>();

    /* renamed from: c */
    private static int f15457c = -1;

    /* renamed from: d */
    public static final /* synthetic */ int f15458d = 0;

    /* renamed from: a */
    public static int m22294a() throws x04 {
        int i;
        if (f15457c == -1) {
            int i2 = 0;
            m04 c = m22296c("video/avc", false, false);
            if (c != null) {
                MediaCodecInfo.CodecProfileLevel[] g = c.mo19321g();
                int length = g.length;
                int i3 = 0;
                while (i2 < length) {
                    int i4 = g[i2].level;
                ...
                i2 = Math.max(i3, wy2.f25579a >= 21 ? 345600 : 172800);
            }
            f15457c = i2;
        }
        return f15457c;
    ...
    public static android.util.Pair<java.lang.Integer, java.lang.Integer> m22295b(com.google.android.gms.internal.ads.C5689w r17) {
        /*
            r0 = r17
            java.lang.String r1 = r0.f25130i
            r2 = 0
        ...
        L_0x0008:
            ...
            java.lang.String r3 = r0.f25133l
            ...
            java.lang.String r0 = r0.f25130i
            int r3 = r1.length
        ...
        L_0x004c:
            ...
            goto L_0x0228
        L_0x004f:
            java.util.regex.Pattern r3 = f15455a
            r2 = r1[r6]
        ...
        L_0x02a6:
            ...
            java.lang.String r3 = com.google.android.gms.internal.ads.C5463pw.m29200d(r3)     // Catch:{ NumberFormatException -> 0x0311 }
        ...
        L_0x032d:
            return r2
        L_0x032e:
            java.lang.String r2 = r0.f25130i
            com.google.android.gms.internal.ads.dy3 r0 = r0.f25145x
            int r11 = r1.length
        ...
        L_0x045d:
            ...
            goto L_0x06d0
        L_0x0460:
            java.util.regex.Pattern r2 = f15455a
            r3 = r1[r6]
        ...
        L_0x0910:
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.d14.m22295b(com.google.android.gms.internal.ads.w):android.util.Pair");
    }

    /* renamed from: c */
    public static m04 m22296c(String str, boolean z, boolean z2) throws x04 {
        List<m04> e = m22298e(str, false, false);
        if (e.isEmpty()) {
            return null;
        }
        return e.get(0);
    ...
    /* renamed from: d */
    public static m04 m22297d() throws x04 {
        return m22296c("audio/raw", false, false);
    }

    /* renamed from: e */
    public static synchronized List<m04> m22298e(String str, boolean z, boolean z2) throws x04 {
        y04 y04;
        String str2 = str;
        boolean z3 = z;
        boolean z4 = z2;
        synchronized (d14.class) {
            v04 v04 = new v04(str2, z3, z4);
            HashMap<v04, List<m04>> hashMap = f15456b;
            List<m04> list = hashMap.get(v04);
            if (list != null) {
                return list;
            }
            int i = wy2.f25579a;
            if (i >= 21) {
                ...
                y04 = new a14((z04) null);
            }
            ArrayList<m04> g = m22300g(v04, y04);
            if (z3 && g.isEmpty() && i >= 21 && i <= 23) {
                g = m22300g(v04, new a14((z04) null));
                if (!g.isEmpty()) {
                    String str3 = g.get(0).f19692a;
            ...
            if ("audio/raw".equals(str2)) {
                if (i < 26 && wy2.f25580b.equals("R9") && g.size() == 1 && g.get(0).f19692a.equals("OMX.MTK.AUDIO.DECODER.RAW")) {
                    g.add(m04.m27054c("OMX.google.raw.decoder", "audio/raw", "audio/raw", (MediaCodecInfo.CodecCapabilities) null, false, true, false, false, false));
                }
                m22301h(g, s04.f23289a);
            }
            if (i < 21 && g.size() > 1) {
                String str4 = g.get(0).f19692a;
                if ("OMX.SEC.mp3.dec".equals(str4) || "OMX.SEC.MP3.Decoder".equals(str4) || "OMX.brcm.audio.mp3.decoder".equals(str4)) {
                    m22301h(g, t04.f23675a);
                }
            }
            if (i < 32 && g.size() > 1 && "OMX.qti.audio.decoder.flac".equals(g.get(0).f19692a)) {
                g.add(g.remove(0));
            }
            List<m04> unmodifiableList = Collections.unmodifiableList(g);
            hashMap.put(v04, unmodifiableList);
            return unmodifiableList;
        }
    }

    /* renamed from: f */
    public static List<m04> m22299f(List<m04> list, C5689w wVar) {
        ArrayList arrayList = new ArrayList(list);
        m22301h(arrayList, new r04(wVar));
        return arrayList;
    }
    ...
    /* renamed from: g */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private static java.util.ArrayList<com.google.android.gms.internal.ads.m04> m22300g(com.google.android.gms.internal.ads.v04 r23, com.google.android.gms.internal.ads.y04 r24) throws com.google.android.gms.internal.ads.x04 {
        /*
            r1 = r23
            r2 = r24
            ...
            java.lang.String r15 = r1.f24536a     // Catch:{ Exception -> 0x0395 }
        ...
        L_0x001a:
            ...
            android.media.MediaCodecInfo r0 = r2.mo15639A(r13)     // Catch:{ Exception -> 0x0395 }
            int r7 = com.google.android.gms.internal.ads.wy2.f25579a     // Catch:{ Exception -> 0x0395 }
            r8 = 29
        ...
        L_0x007b:
            ...
            java.lang.String r11 = com.google.android.gms.internal.ads.wy2.f25580b     // Catch:{ Exception -> 0x0395 }
            boolean r10 = r10.equals(r11)     // Catch:{ Exception -> 0x0395 }
            if (r10 != 0) goto L_0x002c
            java.lang.String r10 = "Xiaomi"
            java.lang.String r5 = com.google.android.gms.internal.ads.wy2.f25581c     // Catch:{ Exception -> 0x0395 }
        ...
        L_0x0111:
            ...
            java.lang.String r10 = com.google.android.gms.internal.ads.wy2.f25580b     // Catch:{ Exception -> 0x0395 }
        ...
        L_0x0153:
            ...
            boolean r5 = r10.equals(r5)     // Catch:{ Exception -> 0x0395 }
            if (r5 == 0) goto L_0x019d
            java.lang.String r5 = com.google.android.gms.internal.ads.wy2.f25580b     // Catch:{ Exception -> 0x0395 }
        ...
        L_0x019d:
            ...
            java.lang.String r8 = com.google.android.gms.internal.ads.wy2.f25581c     // Catch:{ Exception -> 0x0395 }
            boolean r8 = r10.equals(r8)     // Catch:{ Exception -> 0x0395 }
            if (r8 == 0) goto L_0x01db
            java.lang.String r8 = com.google.android.gms.internal.ads.wy2.f25580b     // Catch:{ Exception -> 0x0395 }
        ...
        L_0x01db:
            ...
            java.lang.String r7 = com.google.android.gms.internal.ads.wy2.f25580b     // Catch:{ Exception -> 0x0395 }
        ...
        L_0x025f:
            ...
            boolean r7 = r2.mo15640a(r4, r5, r10)     // Catch:{ Exception -> 0x031c }
            boolean r8 = r2.mo15641b(r4, r5, r10)     // Catch:{ Exception -> 0x031c }
            boolean r11 = r1.f24538c     // Catch:{ Exception -> 0x031c }
        ...
        L_0x0274:
            ...
            goto L_0x002c
        L_0x0278:
            boolean r7 = r2.mo15640a(r3, r5, r10)     // Catch:{ Exception -> 0x031c }
            boolean r8 = r2.mo15641b(r3, r5, r10)     // Catch:{ Exception -> 0x031c }
            boolean r11 = r1.f24537b     // Catch:{ Exception -> 0x031c }
            r19 = 1
        ...
        L_0x0289:
            ...
            r7 = 1
        L_0x028c:
            int r8 = com.google.android.gms.internal.ads.wy2.f25579a     // Catch:{ Exception -> 0x031c }
            r11 = 29
            if (r8 < r11) goto L_0x0297
            boolean r11 = r0.isHardwareAccelerated()     // Catch:{ Exception -> 0x031c }
            goto L_0x02a0
        L_0x0297:
            boolean r11 = m22302i(r0)     // Catch:{ Exception -> 0x031c }
        ...
        L_0x029f:
            r11 = 0
        L_0x02a0:
            boolean r20 = m22302i(r0)     // Catch:{ Exception -> 0x031c }
            r2 = 29
        ...
        L_0x02ad:
            ...
            java.lang.String r0 = com.google.android.gms.internal.ads.a13.m20554a(r0)     // Catch:{ Exception -> 0x031c }
        ...
        L_0x02d0:
            ...
            boolean r2 = r1.f24537b     // Catch:{ Exception -> 0x031c }
        ...
        L_0x02dc:
            ...
            r2 = r15
            r15 = r18
            com.google.android.gms.internal.ads.m04 r0 = com.google.android.gms.internal.ads.m04.m27054c(r7, r8, r9, r10, r11, r12, r13, r14, r15)     // Catch:{ Exception -> 0x02f8 }
        ...
        L_0x0395:
            r0 = move-exception
            com.google.android.gms.internal.ads.x04 r1 = new com.google.android.gms.internal.ads.x04
            r2 = 0
            r1.<init>(r0, r2)
            throw r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.d14.m22300g(com.google.android.gms.internal.ads.v04, com.google.android.gms.internal.ads.y04):java.util.ArrayList");
    }

    /* renamed from: h */
    private static <T> void m22301h(List<T> list, c14<T> c14) {
        Collections.sort(list, new u04(c14));
    }

    /* renamed from: i */
    private static boolean m22302i(MediaCodecInfo mediaCodecInfo) {
        if (wy2.f25579a >= 29) {
            return mediaCodecInfo.isSoftwareOnly();
        }
        String a = a13.m20554a(mediaCodecInfo.getName());
        if (a.startsWith("arc.")) {
            return false;
        }
