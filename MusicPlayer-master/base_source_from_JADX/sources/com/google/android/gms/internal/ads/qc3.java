...
public final class qc3 implements x93 {

    /* renamed from: b */
    private static final ThreadLocal<Cipher> f21901b = new pc3();

    /* renamed from: a */
    private final SecretKey f21902a;

    public qc3(byte[] bArr) throws GeneralSecurityException {
        qk3.m29554a(bArr.length);
        this.f21902a = new SecretKeySpec(bArr, "AES");
    }
    ...
    public final byte[] mo17953a(byte[] bArr, byte[] bArr2) throws GeneralSecurityException {
        ...
        if (length <= 2147483619) {
            ...
            ThreadLocal<Cipher> threadLocal = f21901b;
            threadLocal.get().init(1, this.f21902a, algorithmParameterSpec);
