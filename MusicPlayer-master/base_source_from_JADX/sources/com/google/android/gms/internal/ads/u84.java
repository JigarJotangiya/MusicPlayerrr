...
public final class u84 implements f94 {

    /* renamed from: b */
    private static final int[] f24233b = {5, 4, 12, 8, 3, 10, 9, 11, 6, 2, 0, 1, 7, 14};

    /* renamed from: c */
    private static final Constructor<? extends y84> f24234c;
    ...
    static {
        ...
        try {
            if (Boolean.TRUE.equals(Class.forName("androidx.media3.decoder.flac.FlacLibrary").getMethod("isAvailable", new Class[0]).invoke((Object) null, new Object[0]))) {
                constructor = Class.forName("androidx.media3.decoder.flac.FlacExtractor").asSubclass(y84.class).getConstructor(new Class[]{Integer.TYPE});
            }
    ...
    /* renamed from: b */
    private static final void m31703b(int i, List<y84> list) {
        switch (i) {
            case 0:
                list.add(new C5062f2());
                return;
            case 1:
                list.add(new C5174i2());
                return;
            case 2:
                list.add(new C5285l2(0));
                return;
            case 3:
                list.add(new la4(0));
                return;
            case 4:
                Constructor<? extends y84> constructor = f24234c;
                if (constructor != null) {
                    try {
                        list.add((y84) constructor.newInstance(new Object[]{0}));
                        return;
                    } catch (Exception e) {
            ...
            case 5:
                ...
                return;
            case 6:
                list.add(new C5615u(0));
                return;
            case 7:
                list.add(new C4986d0(0));
                return;
            case 8:
                list.add(new C5764y0(0, (tv2) null));
                list.add(new C4987d1(0));
                return;
            case 9:
                list.add(new C5543s1());
                return;
            case 10:
                list.add(new C5360n3());
                return;
            case 11:
                list.add(new C5730x3(1, 0, 112800));
                return;
            case 12:
                list.add(new C5250k4());
                return;
            case 14:
                list.add(new za4());
                return;
    ...
    public final synchronized com.google.android.gms.internal.ads.y84[] mo15631a(android.net.Uri r19, java.util.Map<java.lang.String, java.util.List<java.lang.String>> r20) {
        /*
            r18 = this;
            monitor-enter(r18)
        ...
        L_0x0038:
            ...
            goto L_0x017f
        L_0x003b:
            java.lang.String r3 = com.google.android.gms.internal.ads.C5463pw.m29201e(r3)     // Catch:{ all -> 0x02f4 }
        ...
        L_0x017f:
            ...
            m31703b(r3, r0)     // Catch:{ all -> 0x02f4 }
        L_0x0184:
        ...
        L_0x02ce:
            ...
            m31703b(r15, r0)     // Catch:{ all -> 0x02f4 }
        L_0x02d5:
            int[] r2 = f24233b     // Catch:{ all -> 0x02f4 }
            r4 = 0
        L_0x02d8:
            ...
            m31703b(r5, r0)     // Catch:{ all -> 0x02f4 }
        L_0x02e3:
            int r4 = r4 + 1
            goto L_0x02d8
        L_0x02e6:
            int r1 = r0.size()     // Catch:{ all -> 0x02f4 }
            com.google.android.gms.internal.ads.y84[] r1 = new com.google.android.gms.internal.ads.y84[r1]     // Catch:{ all -> 0x02f4 }
            java.lang.Object[] r0 = r0.toArray(r1)     // Catch:{ all -> 0x02f4 }
            com.google.android.gms.internal.ads.y84[] r0 = (com.google.android.gms.internal.ads.y84[]) r0     // Catch:{ all -> 0x02f4 }
            monitor-exit(r18)
            return r0
        L_0x02f4:
            r0 = move-exception
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.u84.mo15631a(android.net.Uri, java.util.Map):com.google.android.gms.internal.ads.y84[]");
    }

    public final synchronized y84[] zza() {
        return mo15631a(Uri.EMPTY, new HashMap());
    }
}
