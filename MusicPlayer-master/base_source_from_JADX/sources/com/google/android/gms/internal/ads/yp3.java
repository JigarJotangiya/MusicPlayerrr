...
final class yp3 extends xp3 {
    ...
    public final int mo22064a(int r12, byte[] r13, int r14, int r15) {
        /*
            r11 = this;
            r0 = -19
            r1 = -62
        ...
        L_0x0022:
            ...
            goto L_0x0039
        L_0x0034:
            int r12 = com.google.android.gms.internal.ads.aq3.m20923k(r8, r14)
            return r12
        L_0x0039:
        ...
        L_0x004b:
            ...
            goto L_0x0061
        L_0x005a:
            int r12 = com.google.android.gms.internal.ads.aq3.m20923k(r8, r9)
            return r12
        L_0x005f:
            int r12 = r12 >> 16
        L_0x0061:
            ...
            goto L_0x0072
        L_0x006d:
            int r12 = com.google.android.gms.internal.ads.aq3.m20924l(r8, r9, r14)
            return r12
        L_0x0072:
        ...
        L_0x00ad:
            ...
            int r3 = com.google.android.gms.internal.ads.aq3.m20915c(r13, r12, r15)
            goto L_0x00f2
        L_0x00b8:
            int r8 = r12 + 1
            byte r12 = r13[r12]
        ...
        L_0x00f3:
            ...
            goto L_0x0094
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.yp3.mo22064a(int, byte[], int, int):int");
    }

    /* access modifiers changed from: package-private */
    /* renamed from: b */
    public final String mo22065b(byte[] bArr, int i, int i2) throws bn3 {
        int i3;
        ...
        if ((i | i2 | ((length - i) - i2)) >= 0) {
            ...
            while (r12 < i4) {
                ...
                if (wp3.m33268d(b2)) {
                ...
                } else if (wp3.m33270f(b2)) {
                    if (i6 < i4) {
                        wp3.m33267c(b2, bArr[i6], cArr, i3);
                        r12 = i6 + 1;
                        i3++;
                    } else {
                        throw bn3.zzd();
                    }
                } else if (wp3.m33269e(b2)) {
                    if (i6 < i4 - 1) {
                        int i8 = i6 + 1;
                        wp3.m33266b(b2, bArr[i6], bArr[i8], cArr, i3);
                        r12 = i8 + 1;
                        i3++;
                    } else {
                        throw bn3.zzd();
                    ...
                    int i9 = i6 + 1;
                    int i10 = i9 + 1;
                    wp3.m33265a(b2, bArr[i6], bArr[i9], bArr[i10], cArr, i3);
                    i3 += 2;
                    r12 = i10 + 1;
                } else {
                    throw bn3.zzd();
