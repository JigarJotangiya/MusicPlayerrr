package com.google.android.play.core.install.p251c;
...
public final class C6462a {
    ...
    /* renamed from: a */
    private static final Map<Integer, String> f29748a;

    /* renamed from: b */
    private static final Map<Integer, String> f29749b;
    ...
    /* renamed from: a */
    public static String m37837a(int i) {
        Map<Integer, String> map = f29748a;
        Integer valueOf = Integer.valueOf(i);
        if (!map.containsKey(valueOf)) {
            return BuildConfig.FLAVOR;
        }
        Map<Integer, String> map2 = f29749b;
