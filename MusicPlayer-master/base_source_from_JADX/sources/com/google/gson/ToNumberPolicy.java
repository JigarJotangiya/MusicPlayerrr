...
public enum ToNumberPolicy implements ToNumberStrategy {
    ...
    LAZILY_PARSED_NUMBER {
        public Number readNumber(JsonReader jsonReader) throws IOException {
            return new C6566f(jsonReader.nextString());
        }
    },
    LONG_OR_DOUBLE {
        ...
        public java.lang.Number readNumber(com.google.gson.stream.JsonReader r7) throws java.io.IOException, com.google.gson.JsonParseException {
            ...
            L_0x0047:
                ...
                throw r3
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.gson.ToNumberPolicy.C64803.readNumber(com.google.gson.stream.JsonReader):java.lang.Number");
        }
    },
    BIG_DECIMAL {
