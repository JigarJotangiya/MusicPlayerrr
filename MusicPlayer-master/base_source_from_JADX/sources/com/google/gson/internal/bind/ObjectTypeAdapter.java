...
public final class ObjectTypeAdapter extends TypeAdapter<Object> {
    ...
    /* renamed from: c */
    private static final TypeAdapterFactory f29795c = m37910b(ToNumberPolicy.DOUBLE);

    /* renamed from: a */
    private final Gson f29796a;

    /* renamed from: b */
    private final ToNumberStrategy f29797b;

    /* renamed from: com.google.gson.internal.bind.ObjectTypeAdapter$a */
    static /* synthetic */ class C6503a {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f29799a     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f29799a     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f29799a     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                int[] r0 = f29799a     // Catch:{ NoSuchFieldError -> 0x003e }
            ...
            L_0x003e:
                int[] r0 = f29799a     // Catch:{ NoSuchFieldError -> 0x0049 }
            ...
            L_0x0049:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.gson.internal.bind.ObjectTypeAdapter.C6503a.<clinit>():void");
        }
    }

    /* renamed from: a */
    public static TypeAdapterFactory m37909a(ToNumberStrategy toNumberStrategy) {
        if (toNumberStrategy == ToNumberPolicy.DOUBLE) {
            return f29795c;
        }
        return m37910b(toNumberStrategy);
    }

    /* renamed from: b */
    private static TypeAdapterFactory m37910b(final ToNumberStrategy toNumberStrategy) {
    ...
    public Object read(JsonReader jsonReader) throws IOException {
        switch (C6503a.f29799a[jsonReader.peek().ordinal()]) {
            case 1:
            ...
            case 4:
                return this.f29797b.readNumber(jsonReader);
            case 5:
    ...
    public void write(JsonWriter jsonWriter, Object obj) throws IOException {
        ...
        TypeAdapter<?> adapter = this.f29796a.getAdapter(obj.getClass());
