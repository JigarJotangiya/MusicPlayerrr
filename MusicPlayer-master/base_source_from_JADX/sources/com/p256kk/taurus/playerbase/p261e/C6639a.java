package com.p256kk.taurus.playerbase.p261e;

import android.os.Bundle;
import p453me.zhanghai.android.materialprogressbar.BuildConfig;

/* renamed from: com.kk.taurus.playerbase.e.a */
/* compiled from: DebugLog */
public class C6639a {
    /* renamed from: a */
    public static void m38214a(int i, Bundle bundle) {
        String str;
        if (C6640b.f30031a) {
            if (i != -88000) {
                switch (i) {
            ...
            C6640b.m38217b("frameEvent_error", str);
        }
    }

    /* renamed from: b */
    public static void m38215b(int i, Bundle bundle) {
        String str;
        String str2;
        if (C6640b.f30031a) {
            if (i != 99020) {
                            ...
                            default:
                                switch (i) {
                                    case -99019:
                                        ...
                                        if (bundle != null) {
                                            str2 = ", curr = " + String.valueOf(bundle.getInt("int_arg1")) + ",duration = " + String.valueOf(bundle.getInt("int_arg2")) + ",bufferPercentage = " + String.valueOf(bundle.getInt("int_arg3"));
                                        } else {
            ...
            C6640b.m38216a("frameEvent_play", str);
        }
    }
}
