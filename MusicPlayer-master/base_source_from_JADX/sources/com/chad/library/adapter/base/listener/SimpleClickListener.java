...
public abstract class SimpleClickListener implements RecyclerView.C0816s {
    public static String TAG = "SimpleClickListener";
    protected BaseQuickAdapter baseQuickAdapter;
    private C3713d mGestureDetector;
    ...
    private class ItemTouchHelperGestureListener implements GestureDetector.OnGestureListener {
        ...
        public boolean onDown(MotionEvent motionEvent) {
            ...
            View unused2 = SimpleClickListener.this.mPressedView = this.recyclerView.mo4562S(motionEvent.getX(), motionEvent.getY());
            return false;
        }
        ...
        public void onLongPress(android.view.MotionEvent r10) {
            ...
            L_0x0009:
                ...
                androidx.recyclerview.widget.RecyclerView$c0 r0 = r0.mo4632j0(r2)
        ...
        public boolean onSingleTapUp(MotionEvent motionEvent) {
            if (SimpleClickListener.this.mIsPrepressed && SimpleClickListener.this.mPressedView != null) {
                ...
                BaseViewHolder baseViewHolder = (BaseViewHolder) this.recyclerView.mo4632j0(access$100);
    ...
    public boolean onInterceptTouchEvent(RecyclerView recyclerView2, MotionEvent motionEvent) {
        ...
        if (recyclerView3 == null) {
            this.recyclerView = recyclerView2;
            this.baseQuickAdapter = (BaseQuickAdapter) recyclerView2.getAdapter();
            this.mGestureDetector = new C3713d(this.recyclerView.getContext(), new ItemTouchHelperGestureListener(this.recyclerView));
        } else if (recyclerView3 != recyclerView2) {
            this.recyclerView = recyclerView2;
            this.baseQuickAdapter = (BaseQuickAdapter) recyclerView2.getAdapter();
            this.mGestureDetector = new C3713d(this.recyclerView.getContext(), new ItemTouchHelperGestureListener(this.recyclerView));
        }
        if (!this.mGestureDetector.mo13020a(motionEvent) && motionEvent.getActionMasked() == 1 && this.mIsShowPress) {
            View view = this.mPressedView;
            if (view != null && ((baseViewHolder = (BaseViewHolder) this.recyclerView.mo4632j0(view)) == null || !isHeaderOrFooterView(baseViewHolder.getItemViewType()))) {
    ...
    public void onTouchEvent(RecyclerView recyclerView2, MotionEvent motionEvent) {
        this.mGestureDetector.mo13020a(motionEvent);
    }
}
