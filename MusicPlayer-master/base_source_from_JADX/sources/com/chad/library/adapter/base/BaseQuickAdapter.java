...
public abstract class BaseQuickAdapter<T, K extends BaseViewHolder> extends RecyclerView.C0797h<K> {
    ...
    private void addAnimation(RecyclerView.C0792c0 c0Var) {
    ...
    public void onAttachedToRecyclerView(RecyclerView recyclerView) {
        ...
        if (layoutManager instanceof GridLayoutManager) {
            ...
            gridLayoutManager.mo4445e3(new GridLayoutManager.C0781b() {
                public int getSpanSize(int i) {
                    ...
                    if (BaseQuickAdapter.this.mSpanSizeLookup == null) {
                        if (BaseQuickAdapter.this.isFixedViewType(itemViewType)) {
                            return gridLayoutManager.mo4440W2();
                        }
                        return 1;
                    } else if (BaseQuickAdapter.this.isFixedViewType(itemViewType)) {
                        return gridLayoutManager.mo4440W2();
                    } else {
                        return BaseQuickAdapter.this.mSpanSizeLookup.getSpanSize(gridLayoutManager, i - BaseQuickAdapter.this.getHeaderLayoutCount());
                    }
                }
            });
        }
    ...
    /* access modifiers changed from: protected */
    public void setFullSpan(RecyclerView.C0792c0 c0Var) {
        if (c0Var.itemView.getLayoutParams() instanceof StaggeredGridLayoutManager.LayoutParams) {
            ((StaggeredGridLayoutManager.LayoutParams) c0Var.itemView.getLayoutParams()).mo5086f(true);
        }
    }
        ...
        if (recyclerView != null && (layoutManager = recyclerView.getLayoutManager()) != null) {
            if (layoutManager instanceof LinearLayoutManager) {
                ...
                recyclerView.postDelayed(new Runnable() {
                    public void run() {
                        if (linearLayoutManager.mo4487a2() + 1 != BaseQuickAdapter.this.getItemCount()) {
                ...
                recyclerView.postDelayed(new Runnable() {
                    public void run() {
                        int[] iArr = new int[staggeredGridLayoutManager.mo5081s2()];
                        staggeredGridLayoutManager.mo5078h2(iArr);
    ...
    public View getViewByPosition(RecyclerView recyclerView, int i, int i2) {
        ...
        if (recyclerView == null || (baseViewHolder = (BaseViewHolder) recyclerView.mo4573b0(i)) == null) {
            return null;
        }
