...
@C8533f(mo30599c = "com.coocent.video.videoplayercore.player.PlayerHelper$updateLastPlaybackTime$1", mo30600f = "PlayerHelper.kt", mo30601l = {1271}, mo30602m = "invokeSuspend")
/* compiled from: PlayerHelper.kt */
final class PlayerHelper$updateLastPlaybackTime$1 extends C8539k implements C8574p<C8902r0, C8508d<? super C8457t>, Object> {
    ...
    PlayerHelper$updateLastPlaybackTime$1(PlayerHelper playerHelper, Video video, long j, C8508d<? super PlayerHelper$updateLastPlaybackTime$1> dVar) {
        super(2, dVar);
    ...
    public final C8508d<C8457t> create(Object obj, C8508d<?> dVar) {
        return new PlayerHelper$updateLastPlaybackTime$1(this.this$0, this.$video, this.$time, dVar);
    }

    public final Object invoke(C8902r0 r0Var, C8508d<? super C8457t> dVar) {
        return ((PlayerHelper$updateLastPlaybackTime$1) create(r0Var, dVar)).invokeSuspend(C8457t.f34900a);
    }
