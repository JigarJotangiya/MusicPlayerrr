...
public final class C7941a {
    ...
    public static final int[] ArcProgressView = {R.attr.progressBg, R.attr.progressOnBg};
    public static final int ArcProgressView_progressBg = 0;
    public static final int ArcProgressView_progressOnBg = 1;
    ...
    public static final int[] CarModeView = {R.attr.carIsFavoriteVisible, R.attr.carModeText};
    public static final int CarModeView_carIsFavoriteVisible = 0;
    public static final int CarModeView_carModeText = 1;
    ...
    public static final int f33665xfdeff96 = 1;

    /* renamed from: ConstraintLayout_ReactiveGuide_reactiveGuide_applyToConstraintSet */
    public static final int f33666x2694048c = 2;
    ...
    public static final int[] EffectArcSeekbar = {R.attr.arcMax, R.attr.arcProgress, R.attr.arcProgressBg, R.attr.arcProgressOff, R.attr.arcProgressOn, R.attr.arcThumbOff, R.attr.arcThumbOn, R.attr.arcThumbSelected};
    public static final int EffectArcSeekbar_arcMax = 0;
    public static final int EffectArcSeekbar_arcProgress = 1;
    public static final int EffectArcSeekbar_arcProgressBg = 2;
    public static final int EffectArcSeekbar_arcProgressOff = 3;
    public static final int EffectArcSeekbar_arcProgressOn = 4;
    public static final int EffectArcSeekbar_arcThumbOff = 5;
    public static final int EffectArcSeekbar_arcThumbOn = 6;
    public static final int EffectArcSeekbar_arcThumbSelected = 7;
    public static final int[] EffectVerticalSeekbar = {R.attr.verticalMax, R.attr.verticalProgress};
    public static final int EffectVerticalSeekbar_verticalMax = 0;
    public static final int EffectVerticalSeekbar_verticalProgress = 1;
    ...
    public static final int FastScrollRecyclerView_fastScrollThumbInactiveColor = 8;
    public static final int FastScrollRecyclerView_fastScrollTrackColor = 9;
    ...
    public static final int[] GiftSwitchView = {R.attr.adsIcon, R.attr.switch_time};
    public static final int GiftSwitchView_adsIcon = 0;
    public static final int GiftSwitchView_switch_time = 1;
    ...
    public static final int[] LyricView = {R.attr.lyricCurrentDefaultTextColor, R.attr.lyricCurrentTextColor, R.attr.lyricCurrentTextSize, R.attr.lyricDefaultColor, R.attr.lyricDefaultLabel, R.attr.lyricDividerHeight, R.attr.lyricGravity, R.attr.lyricNormalTextColor, R.attr.lyricNormalTextSize, R.attr.lyricPaddingLeft, R.attr.lyricPaddingRight, R.attr.lyricPlayDrawable, R.attr.lyricTimelineType};
    public static final int LyricView_lyricCurrentDefaultTextColor = 0;
    public static final int LyricView_lyricCurrentTextColor = 1;
    public static final int LyricView_lyricCurrentTextSize = 2;
    public static final int LyricView_lyricDefaultColor = 3;
    public static final int LyricView_lyricDefaultLabel = 4;
    public static final int LyricView_lyricDividerHeight = 5;
    public static final int LyricView_lyricGravity = 6;
    public static final int LyricView_lyricNormalTextColor = 7;
    public static final int LyricView_lyricNormalTextSize = 8;
    public static final int LyricView_lyricPaddingLeft = 9;
    public static final int LyricView_lyricPaddingRight = 10;
    public static final int LyricView_lyricPlayDrawable = 11;
    public static final int LyricView_lyricTimelineType = 12;
    ...
    public static final int[] MarqueeMaskView = {R.attr.maskColor, R.attr.maskRadiusBottom, R.attr.maskRadiusTop};
    public static final int MarqueeMaskView_maskColor = 0;
    public static final int MarqueeMaskView_maskRadiusBottom = 1;
    public static final int MarqueeMaskView_maskRadiusTop = 2;
    public static final int[] MarqueeSmallCircleView = {R.attr.circleStyle, R.attr.isBlackShadow};
    public static final int MarqueeSmallCircleView_circleStyle = 0;
    public static final int MarqueeSmallCircleView_isBlackShadow = 1;
    public static final int[] MarqueeSurfaceView = {R.attr.baseRotateSurfaceView, R.attr.effectiveRadiusBottomInSurfaceView, R.attr.effectiveRadiusBottomOutSurfaceView, R.attr.effectiveRadiusTopInSurfaceView, R.attr.effectiveRadiusTopOutSurfaceView, R.attr.effectiveWidthSurfaceView, R.attr.isCornerBlackSurfaceView, R.attr.isInwardSurfaceView, R.attr.isKnockoutSurfaceView};
    public static final int MarqueeSurfaceView_baseRotateSurfaceView = 0;
    public static final int MarqueeSurfaceView_effectiveRadiusBottomInSurfaceView = 1;
    public static final int MarqueeSurfaceView_effectiveRadiusBottomOutSurfaceView = 2;
    public static final int MarqueeSurfaceView_effectiveRadiusTopInSurfaceView = 3;
    public static final int MarqueeSurfaceView_effectiveRadiusTopOutSurfaceView = 4;
    public static final int MarqueeSurfaceView_effectiveWidthSurfaceView = 5;
    public static final int MarqueeSurfaceView_isCornerBlackSurfaceView = 6;
    public static final int MarqueeSurfaceView_isInwardSurfaceView = 7;
    public static final int MarqueeSurfaceView_isKnockoutSurfaceView = 8;
    public static final int[] MarqueeSweepGradientView = {R.attr.baseRotate, R.attr.effectiveRadiusBottomIn, R.attr.effectiveRadiusBottomOut, R.attr.effectiveRadiusTopIn, R.attr.effectiveRadiusTopOut, R.attr.effectiveWidth, R.attr.isCornerBlack, R.attr.isInward, R.attr.isKnockout};
    public static final int MarqueeSweepGradientView_baseRotate = 0;
    public static final int MarqueeSweepGradientView_effectiveRadiusBottomIn = 1;
    public static final int MarqueeSweepGradientView_effectiveRadiusBottomOut = 2;
    public static final int MarqueeSweepGradientView_effectiveRadiusTopIn = 3;
    public static final int MarqueeSweepGradientView_effectiveRadiusTopOut = 4;
    public static final int MarqueeSweepGradientView_effectiveWidth = 5;
    public static final int MarqueeSweepGradientView_isCornerBlack = 6;
    public static final int MarqueeSweepGradientView_isInward = 7;
    public static final int MarqueeSweepGradientView_isKnockout = 8;
    public static final int[] MarqueeSwitchButton = {R.attr.marqueeOffImage, R.attr.marqueeOnImage, R.attr.marqueePreferenceTitle, R.attr.marqueeSavePreference};
    public static final int[] MarqueeSwitchButton2 = {R.attr.marqueeDefaultState, R.attr.marqueeOffImage2, R.attr.marqueeOnImage2};
    public static final int MarqueeSwitchButton2_marqueeDefaultState = 0;
    public static final int MarqueeSwitchButton2_marqueeOffImage2 = 1;
    public static final int MarqueeSwitchButton2_marqueeOnImage2 = 2;
    public static final int MarqueeSwitchButton_marqueeOffImage = 0;
    public static final int MarqueeSwitchButton_marqueeOnImage = 1;
    public static final int MarqueeSwitchButton_marqueePreferenceTitle = 2;
    public static final int MarqueeSwitchButton_marqueeSavePreference = 3;
    ...
    public static final int[] MaterialSearchView = {16842904, 16842906, 16843088, 16843296, R.attr.searchBackIcon, R.attr.searchBackground, R.attr.searchCloseIcon, R.attr.searchSuggestionBackground, R.attr.searchSuggestionIcon, R.attr.searchVoiceIcon};
    ...
    public static final int[] PressButton = {R.attr.mode_type};
    public static final int PressButton_mode_type = 0;
    ...
    public static final int[] RotateView = {R.attr.buttonClosed, R.attr.buttonDefault, R.attr.buttonSelected};
    public static final int RotateView_buttonClosed = 0;
    public static final int RotateView_buttonDefault = 1;
    public static final int RotateView_buttonSelected = 2;
    public static final int[] RoundProgressView = {R.attr.RoundProgressBgColor, R.attr.RoundProgressColor, R.attr.RoundProgressRadius};
    public static final int RoundProgressView_RoundProgressBgColor = 0;
    public static final int RoundProgressView_RoundProgressColor = 1;
    public static final int RoundProgressView_RoundProgressRadius = 2;
    ...
    public static final int[] SignKeyWordTextView = {R.attr.signText, R.attr.signTextColor};
    public static final int SignKeyWordTextView_signText = 0;
    public static final int SignKeyWordTextView_signTextColor = 1;
    ...
    public static final int f33667xaa980688 = 0;
    ...
    public static final int[] TwoLyricView = {R.attr.twoLyricCurrentDefaultTextColor, R.attr.twoLyricCurrentTextColor, R.attr.twoLyricDefaultColor, R.attr.twoLyricDefaultLabel, R.attr.twoLyricGravity, R.attr.twoLyricMaxLine, R.attr.twoLyricNormalTextColor, R.attr.twoLyricPadding, R.attr.twoLyricShowStroke, R.attr.twoLyricTextBold, R.attr.twoLyricTextSize};
    public static final int TwoLyricView_twoLyricCurrentDefaultTextColor = 0;
    public static final int TwoLyricView_twoLyricCurrentTextColor = 1;
    public static final int TwoLyricView_twoLyricDefaultColor = 2;
    public static final int TwoLyricView_twoLyricDefaultLabel = 3;
    public static final int TwoLyricView_twoLyricGravity = 4;
    public static final int TwoLyricView_twoLyricMaxLine = 5;
    public static final int TwoLyricView_twoLyricNormalTextColor = 6;
    public static final int TwoLyricView_twoLyricPadding = 7;
    public static final int TwoLyricView_twoLyricShowStroke = 8;
    public static final int TwoLyricView_twoLyricTextBold = 9;
    public static final int TwoLyricView_twoLyricTextSize = 10;
    public static final int[] ValueRadioButton = {R.attr.value};
    public static final int ValueRadioButton_value = 0;
    ...
    public static final int[] ddrippleView = {R.attr.normal, R.attr.pressed};
    public static final int ddrippleView_normal = 0;
    public static final int ddrippleView_pressed = 1;
    public static final int[] include = {R.attr.constraintSet};
    public static final int include_constraintSet = 0;
    public static final int[] spectrum = {R.attr.type};
    public static final int spectrum_type = 0;
}
